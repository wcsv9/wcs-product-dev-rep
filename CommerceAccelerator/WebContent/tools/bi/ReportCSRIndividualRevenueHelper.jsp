...
private String generateSortOrderByOption(String container, Hashtable biNLS)
{
   ...
   String result = 	"<FORM NAME=" + container + ">\n" +
						    ...
						    "               " + biNLS.get("CSRIndividualRevenueReportCSRname") + "\n" +
						    "			 </INPUT>\n" +
						    "            <BR>\n" +
                            "            <BR>\n" +
						    "            <INPUT TYPE=RADIO NAME=sortBy VALUE=All>\n" +
						    "               " + biNLS.get("CSRIndividualRevenueReportRevenue") + "\n" +
						    "			 </INPUT>\n" +
						    "            <BR>\n" +	
						    "         </TD>\n" +
						    "      </TR>\n" +
							...
							"            <BR>\n" +
						    "            <INPUT TYPE=RADIO NAME=rankBy VALUE=All>\n" +
						    "               " + biNLS.get("CSRIndividualRevenueReportProfit") + "\n" +
						    "			 </INPUT>\n" +
						    "            <BR>\n" +						            		
							"         </TD>\n" +
							"      </TR>\n" +
...
<SCRIPT>
   ...
   function returnSortByCSRName(container) {
