...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("ageRange")%></TITLE>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperAgeRange");
      ...
      {
		 saveStatOption("myHelperAgeRange");

         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biAgeRangeReportOutputDialog");
         setReportFrameworkReportXML("bi.biAgeRangeReport");

			if (document.forms["myHelperAgeRange"].rbsort[0].checked) {
				  setReportFrameworkParameter("sortOrder","DESC");
			} else {
				  setReportFrameworkParameter("sortOrder","ASC");
			}

		  if (document.forms["myHelperAgeRange"].rbname[0].checked) {
					setReportFrameworkParameter("sortBy","1");
		  } else if (document.forms["myHelperAgeRange"].rbname[1].checked) {
					setReportFrameworkParameter("sortBy","2");
		  } else if (document.forms["myHelperAgeRange"].rbname[2].checked) {
					setReportFrameworkParameter("sortBy","3");
		  }

		  setReportFrameworkReportName("biAgeRangeReport");
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
   function returnStatOptionAgeRange(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=biNLS.get("ageRange") %></H1>
   <%=biNLS.get("ageRangeDescription") %>
    <p>
