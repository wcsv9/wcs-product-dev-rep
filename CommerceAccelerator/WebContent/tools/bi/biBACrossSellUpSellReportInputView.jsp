...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBACrossSellUpSellReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBACrossSellUpSell");
		 ResetValues();
      ...
      {
        saveStatOption("myHelperBACrossSellUpSell");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBACrossSellUpSellReportOutputDialog");
		setReportFrameworkReportXML("bi.biBACrossSellUpSellReport");

		if (document.forms["myHelperBACrossSellUpSell"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBACrossSellUpSell"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","4");
		} else if (document.forms["myHelperBACrossSellUpSell"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","5");
		} else if (document.forms["myHelperBACrossSellUpSell"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","6");
		}  

		setReportFrameworkReportName("biBACrossSellUpSellReport");
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionInitName(container) {
      return document.forms[container].rbname[0].checked;
   }
   function returnSortByOptionInitStartDate(container) {
      return document.forms[container].rbname[1].checked;
   }
   function returnSortByOptionInitEndDate(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBACrossSellUpSell")%></LABEL></h1>
	<LABEL><%=biNLS.get("biBACrossSellUpSellDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBACrossSellUpSellReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBACrossSellUpSell> 
