...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsAddedToShoppingCartMostReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsAddedToShoppingCartMost");
		 ResetValues();
      ...
      {
         saveStatOption("myHelperBAProductsAddedToShoppingCartMost");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBAProductsAddedToShoppingCartMostReportOutputDialog");
		setReportFrameworkReportXML("bi.biBAProductsAddedToShoppingCartMostReport");

		if (document.forms["myHelperBAProductsAddedToShoppingCartMost"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBAProductsAddedToShoppingCartMost"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperBAProductsAddedToShoppingCartMost"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		}  

		setReportFrameworkReportName("biBAProductsAddedToShoppingCartMostReport");
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsAddedToShoppingCartMost") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsAddedToShoppingCartMostDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsAddedToShoppingCartMostReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBAProductsAddedToShoppingCartMost>
