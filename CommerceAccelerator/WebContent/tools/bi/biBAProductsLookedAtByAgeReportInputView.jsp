...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsLookedAtByAgeReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsLookedAtByAge");
		 ResetValues();
      ...
      {
        saveStatOption("myHelperBAProductsLookedAtByAge");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBAProductsLookedAtByAgeReportOutputDialog");
		setReportFrameworkReportXML("bi.biBAProductsLookedAtByAgeReport");

		if (document.forms["myHelperBAProductsLookedAtByAge"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBAProductsLookedAtByAge"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperBAProductsLookedAtByAge"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","3");
		}  

		setReportFrameworkReportName("biBAProductsLookedAtByAgeReport");
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionAgeRange(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsLookedAtByAge") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsLookedAtByAgeDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsLookedAtByAgeReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBAProductsLookedAtByAge>
