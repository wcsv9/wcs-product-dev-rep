...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsLookedAtByGenderReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsLookedAtByGender");
		 ResetValues();
      ...
      {
         saveStatOption("myHelperBAProductsLookedAtByGender");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBAProductsLookedAtByGenderReportOutputDialog");
		setReportFrameworkReportXML("bi.biBAProductsLookedAtByGenderReport");

		if (document.forms["myHelperBAProductsLookedAtByGender"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBAProductsLookedAtByGender"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperBAProductsLookedAtByGender"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","3");
		}  

		setReportFrameworkReportName("biBAProductsLookedAtByGenderReport");
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionGender(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsLookedAtByGender") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsLookedAtByGenderDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsLookedAtByGenderReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBAProductsLookedAtByGender>
