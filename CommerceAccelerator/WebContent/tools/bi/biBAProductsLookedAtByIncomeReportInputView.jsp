...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsLookedAtByIncomeReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsLookedAtByIncome");
		 ResetValues();
      ...
      {
         saveStatOption("myHelperBAProductsLookedAtByIncome");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBAProductsLookedAtByIncomeReportOutputDialog");
		setReportFrameworkReportXML("bi.biBAProductsLookedAtByIncomeReport");

		if (document.forms["myHelperBAProductsLookedAtByIncome"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBAProductsLookedAtByIncome"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperBAProductsLookedAtByIncome"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","3");
		} 

		setReportFrameworkReportName("biBAProductsLookedAtByIncomeReport");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionIncomeRange(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsLookedAtByIncome") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsLookedAtByIncomeDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsLookedAtByIncomeReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBAProductsLookedAtByIncome>
