...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsLookedAtByMaritalStatusReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsLookedAtByMaritalStatus");
		 ResetValues();
      ...
      {
        saveStatOption("myHelperBAProductsLookedAtByMaritalStatus");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBAProductsLookedAtByMaritalStatusReportOutputDialog");
		setReportFrameworkReportXML("bi.biBAProductsLookedAtByMaritalStatusReport");

		if (document.forms["myHelperBAProductsLookedAtByMaritalStatus"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBAProductsLookedAtByMaritalStatus"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperBAProductsLookedAtByMaritalStatus"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","3");
		}  

		setReportFrameworkReportName("biBAProductsLookedAtByMaritalStatusReport");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionMaritalStatus(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsLookedAtByMaritalStatus") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsLookedAtByMaritalStatusDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsLookedAtByMaritalStatusReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBAProductsLookedAtByMaritalStatus>
