...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsLookedAtBySingleUserReport")%></LABEL></title>
...
<SCRIPT>
   ...
   function returnSortByOptionNumOfProdAdded(container) {
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsLookedAtBySingleUser");
		 ResetValues();
      ...
      function savePanelData()
      {
         ...
         setReportFrameworkParameter("XMLFile","bi.biBAProductsLookedAtBySingleUserReportOutputDialog");
         setReportFrameworkReportXML("bi.biBAProductsLookedAtBySingleUserReport");
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report framework particulars
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         if(returnSortByOptionNumOfProdAdded("myHelperBAProductsLookedAtBySingleUser")){

			// ASC & DESC CHECKING QUERY
				if(returnOrderbyDesc("myHelperBAProductsLookedAtBySingleUser")){
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReport"+ document.all.time[document.all.time.selectedIndex].value+"NumOfProdAdded");
				}
				else{
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReport"+ document.all.time[document.all.time.selectedIndex].value+"NumOfProdAddedAscend");
				}
		 }
		  else{
				if(returnOrderbyDesc("myHelperBAProductsLookedAtBySingleUser")){
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReport"+ document.all.time[document.all.time.selectedIndex].value+"ProductName");
				}
				else{
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReport"+ document.all.time[document.all.time.selectedIndex].value+"ProductNameAscend");
				}
       	  }
		...
		else
		{
         ...
         if(returnSortByOptionNumOfProdAdded("myHelperBAProductsLookedAtBySingleUser")){
			...
			// ASC & DESC CHECKING QUERY
				if(returnOrderbyDesc("myHelperBAProductsLookedAtBySingleUser")){
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReportNumOfProdAdded");
				}
				else{
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReportNumOfProdAddedAscend");
				}
         }
		 else{
				if(returnOrderbyDesc("myHelperBAProductsLookedAtBySingleUser")){
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReportProductName");
				}
				else{
					setReportFrameworkReportName("biBAProductsLookedAtBySingleUserReportProductNameAscend");
				}
       	  }
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsLookedAtBySingleUser") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsLookedAtBySingleUserDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsLookedAtBySingleUserReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-left:0">
		<%=generateSortOrderByOption("myHelperBAProductsLookedAtBySingleUser", biNLS)%>
	</div>
