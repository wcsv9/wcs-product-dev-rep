...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biBAProductsLookedAtMostReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperBAProductsLookedAtMost");
		 ResetValues();
      ...
      {
         saveStatOption("myHelperBAProductsLookedAtMost");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biBAProductsLookedAtMostReportOutputDialog");
		setReportFrameworkReportXML("bi.biBAProductsLookedAtMostReport");

		if (document.forms["myHelperBAProductsLookedAtMost"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperBAProductsLookedAtMost"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperBAProductsLookedAtMost"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		}  

		setReportFrameworkReportName("biBAProductsLookedAtMostReport");
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionPartNumber(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biBAProductsLookedAtMost") %></LABEL></h1>
	<LABEL><%=biNLS.get("biBAProductsLookedAtMostDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biBAProductsLookedAtMostReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperBAProductsLookedAtMost>
