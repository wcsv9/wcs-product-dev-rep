...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("cieCombinationDisplayedClickedAbandoned")%></title>
   ...
   <SCRIPT>
      ...
      function initializeValues()
      {
         //onLoadStartDateEndDate("enquiryPeriod");
                ResetValues();
               onLoadStatOption("myHelperCIECombinationDisplayedClickedAbandoned");
      ...
      function savePanelData()
      {
         ...
         ////////////////////////////////////////////////////////////////////////////////////////////////////
              ...
              saveStatOption("myHelperCIECombinationDisplayedClickedAbandoned");

        setReportFrameworkOutputView("DialogView");
              setReportFrameworkParameter("XMLFile","bi.biCIECombinationDisplayedClickedAbandonedReportOutputDialog");
        setReportFrameworkReportXML("bi.biCIECombinationDisplayedClickedAbandonedReport");


		if (document.forms["myHelperCIECombinationDisplayedClickedAbandoned"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperCIECombinationDisplayedClickedAbandoned"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperCIECombinationDisplayedClickedAbandoned"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperCIECombinationDisplayedClickedAbandoned"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","3");
		} else if (document.forms["myHelperCIECombinationDisplayedClickedAbandoned"].rbname[3].checked) {
			setReportFrameworkParameter("sortBy","4");
		}

		setReportFrameworkReportName("biCIECombinationAbandonedReport");
   ...
   function returnStatOptionEMarketing(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("cieCombinationDisplayedClickedAbandoned") %></h1>
   <%=biNLS.get("cieCombinationDisplayedClickedAbandonedDescription") %>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
       ...
       <DIV ID=pageBody STYLE="display: block; margin-left:0">
       		<FORM NAME=myHelperCIECombinationDisplayedClickedAbandoned>
       							...
       							<TR HEIGHT=5>
       								<TD ALIGN=left VALIGN=TOP>
       									...
       									<INPUT TYPE=RADIO NAME=rbname VALUE=PayA id=s4>
       										<label for= s4>
       											<%=biNLS.get("displayedClickedAbandoned")%>
       										</label>
       									</INPUT>
       									<BR>
       								</TD>
