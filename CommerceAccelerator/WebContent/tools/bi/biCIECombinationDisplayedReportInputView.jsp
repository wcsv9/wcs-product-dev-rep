...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("eMarketingSpotClicked")%></title>
   ...
   <SCRIPT>
      ...
      function initializeValues()
      {
         //onLoadStartDateEndDate("enquiryPeriod");
                ResetValues();
               onLoadStatOption("myHelperCIECombinationDisplayed");
      ...
      function savePanelData()
      {
         ...
         ////////////////////////////////////////////////////////////////////////////////////////////////////
              ...
              saveStatOption("myHelperCIECombinationDisplayed");

              setReportFrameworkOutputView("DialogView");
              setReportFrameworkParameter("XMLFile","bi.biCIECombinationDisplayedReportOutputDialog");
              setReportFrameworkReportXML("bi.biCIECombinationDisplayedReport");

		if (document.forms["myHelperCIECombinationDisplayed"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperCIECombinationDisplayed"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperCIECombinationDisplayed"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperCIECombinationDisplayed"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","3");
		} else if (document.forms["myHelperCIECombinationDisplayed"].rbname[3].checked) {
			setReportFrameworkParameter("sortBy","4");
		} else if (document.forms["myHelperCIECombinationDisplayed"].rbname[4].checked) {
			setReportFrameworkParameter("sortBy","5");
		} else if (document.forms["myHelperCIECombinationDisplayed"].rbname[5].checked) {
			setReportFrameworkParameter("sortBy","6");
		}

		setReportFrameworkReportName("biCIECombinationReport");
  ...
  function saveStatOption(container)
   ...
   function returnStatOptionClickedOrdered(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("cieCombinationDisplayed") %></h1>
   <%=biNLS.get("cieCombinationDisplayedDescription") %>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
       ...
       <DIV ID=pageBody STYLE="display: block; margin-left:0">
       	<FORM NAME=myHelperCIECombinationDisplayed>
              					...
              					<TR HEIGHT=5>
              						<TD ALIGN=left VALIGN=TOP>
              							...
              							<INPUT TYPE=RADIO NAME=rbname VALUE=PayA id=s6>
              								<label for= s6>
              									<%=biNLS.get("displayedClickedOrdered")%>
              								</label>
              							</INPUT>
              							<BR>
              						</TD>
