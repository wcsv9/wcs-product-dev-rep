...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("campaignClickedAbandoned")%></LABEL></title>
   ...
   <SCRIPT SRC="/wcs/javascript/tools/reporting/ReportHelpers.js"></SCRIPT>
    ...
    <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperCampaignClickedAbandoned");
      ...
      {
		 saveStatOption("myHelperCampaignClickedAbandoned");
         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biCampaignClickedAbandonedReportOutputDialog");
         setReportFrameworkReportXML("bi.biCampaignClickedAbandonedReport");


	  	if (document.forms["myHelperCampaignClickedAbandoned"].rbsort[0].checked) {
			 setReportFrameworkParameter("sortOrder","DESC");
	  	} else {
			 setReportFrameworkParameter("sortOrder","ASC");
	  	}

		if (document.forms["myHelperCampaignClickedAbandoned"].rbname[0].checked) {
			   setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperCampaignClickedAbandoned"].rbname[1].checked) {
			   setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperCampaignClickedAbandoned"].rbname[2].checked) {
			   setReportFrameworkParameter("sortBy","3");
		} else if (document.forms["myHelperCampaignClickedAbandoned"].rbname[3].checked) {
			   setReportFrameworkParameter("sortBy","4");
		}

		setReportFrameworkReportName("biCampaignAbandonedReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><LABEL><%=biNLS.get("campaignClickedAbandoned") %></LABEL></h1>
   <LABEL><%=biNLS.get("campaignClickedAbandonedDescription") %></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperCampaignClickedAbandoned>
			<TABLE border=0 bordercolor=red CELLPADDING=0 CELLSPACING=0 width=400>
					 <TR>
						 <TD ALIGN=left VALIGN=TOP>
							...
							<label for="s2">
							   <%=biNLS.get("clicked/abandoned")%></label>
							 </INPUT>
							<BR>
						 </TD>
					  </TR>
