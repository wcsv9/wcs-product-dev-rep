...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("campaignDisplayed")%></LABEL></title>
   ...
   <SCRIPT>
	...
	function initializeValues() {
    	ResetValues();
		onLoadStatOption("myHelperCampaignDisplayed");
	...
	function savePanelData() {
		saveStatOption("myHelperCampaignDisplayed");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biCampaignDisplayedReportOutputDialog");
		setReportFrameworkReportXML("bi.biCampaignDisplayedReport");

		if (document.forms["myHelperCampaignDisplayed"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperCampaignDisplayed"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperCampaignDisplayed"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperCampaignDisplayed"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","3");
		} else if (document.forms["myHelperCampaignDisplayed"].rbname[3].checked) {
			setReportFrameworkParameter("sortBy","4");
		}

		setReportFrameworkReportName("biCampaignReport");
...
<h1><LABEL><%=biNLS.get("campaignDisplayed") %></LABEL></h1>
<LABEL><%=biNLS.get("campaignDisplayedDescription") %></LABEL>
<p>
...
<DIV ID=pageBody STYLE="display: block; margin-left:0">
	<FORM NAME=myHelperCampaignDisplayed>
