...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <TITLE><%=biNLS.get("geographicCity")%></TITLE>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperGeographicCity");
      ...
      function savePanelData()
      {
		 ...
		 saveStatOption("myHelperGeographicCity");

         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biGeographicCityReportOutputDialog");
         setReportFrameworkReportXML("bi.biGeographicCityReport");


		if (document.forms["myHelperGeographicCity"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperGeographicCity"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperGeographicCity"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperGeographicCity"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","4");
		} else if (document.forms["myHelperGeographicCity"].rbname[3].checked) {
			setReportFrameworkParameter("sortBy","5");
		}

		setReportFrameworkReportName("biGeographicCityReport");
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////  
	...
	function returnStatOptionCity(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=biNLS.get("geographicCity") %></H1>
   <%=biNLS.get("geographicCityDescription") %>
    <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left: 0">
		<FORM NAME=myHelperGeographicCity>
