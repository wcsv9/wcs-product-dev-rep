...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <TITLE><%=biNLS.get("geographicCountry")%></TITLE>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperGeographicCountry");
      ...
      function savePanelData()
      {
		 ...
		 saveStatOption("myHelperGeographicCountry");

         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biGeographicCountryReportOutputDialog");
         setReportFrameworkReportXML("bi.biGeographicCountryReport");

		if (document.forms["myHelperGeographicCountry"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperGeographicCountry"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperGeographicCountry"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperGeographicCountry"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","3");
		}

		setReportFrameworkReportName("biGeographicCountryReport");
  ...
  function saveStatOption(container)
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////  
	...
	function returnStatOptionCountry(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=biNLS.get("geographicCountry") %></H1>
   <%=biNLS.get("geographicCountryDescription") %>
    <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperGeographicCountry>
