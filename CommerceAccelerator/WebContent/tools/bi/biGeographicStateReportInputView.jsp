...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <TITLE><%=biNLS.get("geographicState")%></TITLE>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperGeographicState");
      ...
      function savePanelData()
      {
		 ...
		 saveStatOption("myHelperGeographicState");

         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biGeographicStateReportOutputDialog");
         setReportFrameworkReportXML("bi.biGeographicStateReport");


		if (document.forms["myHelperGeographicState"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperGeographicState"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperGeographicState"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","3");
		} else if (document.forms["myHelperGeographicState"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","4");
		}

		setReportFrameworkReportName("biGeographicStateReport");
  ...
  function saveStatOption(container)
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////  
	...
	function returnStatOptionState(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=biNLS.get("geographicState") %></H1>
   <%=biNLS.get("geographicStateDescription") %>
    <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperGeographicState>
