...
<HEAD>
  <link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <TITLE><%=biNLS.get("biICAReviewSalesReportWindowTitle")%></TITLE>
  ...
  <SCRIPT>
      ...
      function initializeValues()
      {
         ...
         onLoadSortOrderByOption("myHelperReviewSales");
		 ResetValues();
      ...
      {
		saveStatOption("myHelperReviewSales");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biICAReviewSalesReportOutputDialog");
		setReportFrameworkParameter("logon_id",document.LogonId.EnterLogonId.value);
		setReportFrameworkReportXML("bi.biICAReviewSalesReport");

		if (document.forms["myHelperReviewSales"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperReviewSales"].rbname.checked) {
			setReportFrameworkParameter("sortBy","1");
		}  
		
		if(document.LogonId.EnterLogonId.value == "" )
			setReportFrameworkReportName("biICAReviewSalesReport");
		else
			setReportFrameworkReportName("biICAReviewSalesReportLogonID");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=biNLS.get("biICAReviewSalesReportWindowTitle") %></H1>
   <%=biNLS.get("biICAReviewSalesReportDescription")%>
   ...
   <p></p>
   <%=biNLS.get("biICAReviewSalesReportSelection")%>
   <p>
