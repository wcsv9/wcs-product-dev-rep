...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("incomeRange")%></title>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperIncomeRange");
      ...
      function savePanelData() {
		 saveStatOption("myHelperIncomeRange");
         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biIncomeRangeReportOutputDialog");
         setReportFrameworkReportXML("bi.biIncomeRangeReport");

                if (document.forms["myHelperIncomeRange"].rbsort[0].checked) {
                      setReportFrameworkParameter("sortOrder","DESC");
                } else {
                      setReportFrameworkParameter("sortOrder","ASC");
                }

              if (document.forms["myHelperIncomeRange"].rbname[0].checked) {
                        setReportFrameworkParameter("sortBy","1");
              } else if (document.forms["myHelperIncomeRange"].rbname[1].checked) {
                        setReportFrameworkParameter("sortBy","2");
              } else if (document.forms["myHelperIncomeRange"].rbname[2].checked) {
                        setReportFrameworkParameter("sortBy","3");
              }

              setReportFrameworkReportName("biIncomeRangeReport");
  ...
  function saveStatOption(container)
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
   function returnStatOptionIncomeRange(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("incomeRange") %></h1>
   <%=biNLS.get("incomeRangeDescription") %>
    <p>
