...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("maritalStatus")%></title>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperMaritalStatus");
      ...
      {
		 saveStatOption("myHelperMaritalStatus");
         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biMaritalStatusReportOutputDialog");
         setReportFrameworkReportXML("bi.biMaritalStatusReport");


                if (document.forms["myHelperMaritalStatus"].rbsort[0].checked) {
                      setReportFrameworkParameter("sortOrder","DESC");
                } else {
                      setReportFrameworkParameter("sortOrder","ASC");
                }

              if (document.forms["myHelperMaritalStatus"].rbname[0].checked) {
                        setReportFrameworkParameter("sortBy","1");
              } else if (document.forms["myHelperMaritalStatus"].rbname[1].checked) {
                        setReportFrameworkParameter("sortBy","2");
              } else if (document.forms["myHelperMaritalStatus"].rbname[2].checked) {
                        setReportFrameworkParameter("sortBy","3");
              } else if (document.forms["myHelperMaritalStatus"].rbname[3].checked) {
                        setReportFrameworkParameter("sortBy","4");
              }

              setReportFrameworkReportName("biMaritalStatusReport");
  ...
  function saveStatOption(container)
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
   function returnStatOptionMaritalStatus(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("maritalStatus") %></h1>
   <%=biNLS.get("maritalStatusDescription") %>
    <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-center:5">
		<FORM NAME=myHelperMaritalStatus>
