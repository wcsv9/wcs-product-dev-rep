   ...
   <script>
      ...
      function initializeValues()
      {
         //onLoadStartDateEndDate("enquiryPeriod");
                ResetValues();
                onLoadStatOption("myHelperMarketplaceActivityReseller");
       ...
       function savePanelData()
      {
               ...
               saveStatOption("myHelperMarketplaceActivityReseller");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biMarketplaceActivityResellerReportOutputDialog");
		setReportFrameworkReportXML("bi.biMarketplaceActivityResellerReport");

		if (document.forms["myHelperMarketplaceActivityReseller"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperMarketplaceActivityReseller"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","11");
		} else if (document.forms["myHelperMarketplaceActivityReseller"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","7");
		}  

		setReportFrameworkReportName("biMarketplaceActivityResellerReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("marketplaceActivityReseller") %></h1>
   <%=biNLS.get("marketplaceActivityResellerDescription") %>
   <p>
...
<FORM NAME=myHelperMarketplaceActivityReseller>
