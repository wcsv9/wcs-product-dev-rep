   ...
   <script>
      ...
      function initializeValues()
      {
         //onLoadStartDateEndDate("enquiryPeriod");
                ResetValues();
                onLoadStatOption("myHelperMarketplaceActivityTop10Ordered");
      ...
      {
		saveStatOption("myHelperMarketplaceActivityTop10Ordered");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biMarketplaceActivityTop10OrderedReportOutputDialog");
		setReportFrameworkReportXML("bi.biMarketplaceActivityTop10OrderedReport");

		if (document.forms["myHelperMarketplaceActivityTop10Ordered"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperMarketplaceActivityTop10Ordered"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","11");
		} else if (document.forms["myHelperMarketplaceActivityTop10Ordered"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","7");
		 }

		setReportFrameworkReportName("biMarketplaceActivityTop10OrderedReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("marketplaceActivityTop10Ordered") %></h1>
   <%=biNLS.get("marketplaceActivityTop10OrderedDescription") %>
   <p>
...
<DIV ID=pageBody STYLE="display: block; margin-left:0">
   ...
   <FORM NAME=myHelperMarketplaceActivityTop10Ordered>
