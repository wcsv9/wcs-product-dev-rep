   ...
   <script>
      ...
      function initializeValues()
      {
         //onLoadStartDateEndDate("enquiryPeriod");
                ResetValues();
                onLoadStatOption("myHelperMarketplaceActivityTop10Transferred");
       ...
       function savePanelData()
      {
        ...
        saveStatOption("myHelperMarketplaceActivityTop10Transferred");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biMarketplaceActivityTop10TransferredReportOutputDialog");
		setReportFrameworkReportXML("bi.biMarketplaceActivityTop10TransferredReport");

		if (document.forms["myHelperMarketplaceActivityTop10Transferred"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperMarketplaceActivityTop10Transferred"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","12");
		} else if (document.forms["myHelperMarketplaceActivityTop10Transferred"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","7");
		}  

		setReportFrameworkReportName("biMarketplaceActivityTop10TransferredReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("marketplaceActivityTop10Transferred") %></h1>
   <%=biNLS.get("marketplaceActivityTop10TransferredDescription") %>
   <p>
...
<DIV ID=pageBody STYLE="display: block; margin-left:0">
   ...
   <FORM NAME=myHelperMarketplaceActivityTop10Transferred>
