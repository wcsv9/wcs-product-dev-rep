...
<%@include file="/tools/reporting/ReportFrameworkHelper.jsp" %>
   ...
   <%=fHeader%>
    ...
    <title><LABEL><%=biNLS.get("biReviewListPriceChangeReportWindowTitle")%></LABEL></title>
   ...
   <SCRIPT>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperListPriceChange");
		 ResetValues();
      ...
      function savePanelData()
      {
		 ...
		 saveSortOrderByOption("myHelperListPriceChange");

         setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biReviewListPriceChangeReportOutputDialog");
         setReportFrameworkReportXML("bi.biReviewListPriceChangeReport");
         
		if (document.forms["myHelperListPriceChange"].orderBy[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperListPriceChange"].sortBy[0].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperListPriceChange"].sortBy[1].checked) {
			setReportFrameworkParameter("sortBy","5");
		}

		setReportFrameworkReportName("biPriceChangeReport");
   ...
   function returnSortByOptionProdName(container) {
      return document.forms[container].sortBy[0].checked;
   }
   function returnSortByOptionChangedPrice(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><LABEL><%=biNLS.get("biReviewListPriceChangeReportWindowTitle") %></LABEL></h1>
   <LABEL><%=biNLS.get("biReviewListPriceChangeReportDescription")%></LABEL>

   <p></p>
   <LABEL><%=biNLS.get("biReviewListPriceChangeReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-center:5">
		<FORM NAME=myHelperListPriceChange>
