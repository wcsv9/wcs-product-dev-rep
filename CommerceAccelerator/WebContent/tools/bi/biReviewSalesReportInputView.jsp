...
<HEAD>
   ...
   <%=fHeader%>
    ...
    <TITLE><%=biNLS.get("biReviewSalesReportWindowTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperReviewSales");
      ...
      function savePanelData()
      {
		 ...
		 setReportFrameworkParameter("XMLFile","bi.biReviewSalesReportOutputDialog");
		 setReportFrameworkReportXML("bi.biReviewSalesReport");
		...
		if (document.forms["myHelperReviewSales"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","1");
		} else if (document.forms["myHelperReviewSales"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","4");
		} else if (document.forms["myHelperReviewSales"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","8");
		}

		setReportFrameworkReportName("biReviewSalesReport");
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
   function returnSortByOptionCustomerName(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=biNLS.get("biReviewSalesReportWindowTitle") %></H1>
   <%=biNLS.get("biReviewSalesReportDescription")%>
   ...
   <p></p>
   <%=biNLS.get("biReviewSalesReportSelection")%>
   <p>
						...
						<TABLE border=0 bordercolor=black CELLPADDING=0 CELLSPACING=0 width=200>
							<TR HEIGHT=5>
								<TD ALIGN=left VALIGN=TOP>
									...
									<BR>
									<BR>
									<INPUT TYPE=RADIO id="s3" NAME=rbname VALUE=All>
										<label for="s3">
											<%=biNLS.get("item")%>
										</label>
									</INPUT>
