...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("salesByContract")%></LABEL></title>
  ...
  <SCRIPT>
       ...
       function initializeValues()
      {
		 ...
		 ResetValues();
		 onLoadStatOption("myHelperSalesByContract");
      ...
      {
	       saveStatOption("myHelperSalesByContract");
	     		setReportFrameworkOutputView("DialogView");
	     		setReportFrameworkParameter("XMLFile","bi.biSalesByContractReportOutputDialog");
	     		setReportFrameworkReportXML("bi.biSalesByContractReport");
	     
	     		if (document.forms["myHelperSalesByContract"].rbsort[0].checked) {
	     			setReportFrameworkParameter("sortOrder","DESC");
	     		} else {
	     			setReportFrameworkParameter("sortOrder","ASC");
	     		}
	     
	     		if (document.forms["myHelperSalesByContract"].rbname[0].checked) {
	     			setReportFrameworkParameter("sortBy","2");
	     		} else if (document.forms["myHelperSalesByContract"].rbname[1].checked) {
	     			setReportFrameworkParameter("sortBy","3");
	     		} else if (document.forms["myHelperSalesByContract"].rbname[2].checked) {
	     			setReportFrameworkParameter("sortBy","4");
	     		} 
	     		 
	     
	     		setReportFrameworkReportName("biSalesByContractReport");
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  function saveStatOption(container)
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////  
    function returnStatOptionContractName(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><LABEL><%=biNLS.get("salesByContract") %></LABEL></h1>
   <LABEL><%=biNLS.get("salesByContractDescription") %></LABEL>
    <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperSalesByContract>
