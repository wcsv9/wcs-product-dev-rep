...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("shoppingCartAbandoned")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperShoppingCartByAbandoned");
		 ResetValues();
      ...
      {
         saveStatOption("myHelperShoppingCartByAbandoned");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biShoppingCartAbandonedReportOutputDialog");
		setReportFrameworkReportXML("bi.biShoppingCartAbandonedReport");

		if (document.forms["myHelperShoppingCartByAbandoned"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperShoppingCartByAbandoned"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperShoppingCartByAbandoned"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","1");
		}  

		setReportFrameworkReportName("biShoppingCartAbandonedReport");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function returnSortByOptionDistributorName(container) {
...
<body onload="initializeValues()" class="content">
   ...
   <h1><LABEL><%=biNLS.get("shoppingCartAbandoned") %></LABEL></h1>
   <LABEL><%=biNLS.get("shoppingCartAbandonedDescription") %></LABEL>
   <p></p>
   <LABEL><%=biNLS.get("shoppingCartAbandonedReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperShoppingCartByAbandoned>
