...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("shoppingCartValue")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperShoppingCartByValue");
		 ResetValues();
      ...
      {
         saveStatOption("myHelperShoppingCartByValue");
		setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","bi.biShoppingCartValueReportOutputDialog");
		setReportFrameworkReportXML("bi.biShoppingCartValueReport");

		if (document.forms["myHelperShoppingCartByValue"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperShoppingCartByValue"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","2");
		} else if (document.forms["myHelperShoppingCartByValue"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","6");
		} else if (document.forms["myHelperShoppingCartByValue"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","9");
		}  

		setReportFrameworkReportName("biShoppingCartValueReport");
   ...
   function returnSortByOptionNumofUnits(container) {
      return document.forms[container].rbname[1].checked;
   }
   function returnSortByOptionSalesValue(container) {
...
<body onload="initializeValues()" class="content">
   ...
   <h1><LABEL><%=biNLS.get("shoppingCartValue") %></LABEL></h1>
   <LABEL><%=biNLS.get("shoppingCartValueDescription") %></LABEL>
   <p></p>
   <LABEL><%=biNLS.get("shoppingCartValueReportSelection")%></LABEL>
   <p>
...
<FORM NAME=myHelperShoppingCartByValue>
