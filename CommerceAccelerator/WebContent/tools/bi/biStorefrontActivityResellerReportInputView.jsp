...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("storefrontActivityReseller")%></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		  ...
		  ResetValues();
		  onLoadStatOption("myHelperStorefrontActivityReseller");
       ...
       function savePanelData()
      {
		 ...
		 saveStatOption("myHelperStorefrontActivityReseller");
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report framework particulars
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biStorefrontActivityResellerReportOutputDialog");
         setReportFrameworkReportXML("bi.biStorefrontActivityResellerReport");

		if (document.forms["myHelperStorefrontActivityReseller"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperStorefrontActivityReseller"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","9");
		} else if (document.forms["myHelperStorefrontActivityReseller"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","12");
		}

		setReportFrameworkReportName("biStorefrontActivityResellerReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("storefrontActivityReseller") %></h1>
   <%=biNLS.get("storefrontActivityResellerDescription") %>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperStorefrontActivityReseller>
