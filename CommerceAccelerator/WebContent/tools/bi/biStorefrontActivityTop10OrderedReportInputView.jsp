...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("storefrontActivityTop10Ordered")%></title>
   ...
   <script>
      ...
      function initializeValues()
      {
         //onLoadStartDateEndDate("enquiryPeriod");
		  ResetValues();
		  onLoadStatOption("myHelperStorefrontActivityTop10Ordered");
       ...
       function savePanelData()
      {
		 ...
		 saveStatOption("myHelperStorefrontActivityTop10Ordered");
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report framework particulars
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biStorefrontActivityTop10OrderedReportOutputDialog");
         setReportFrameworkReportXML("bi.biStorefrontActivityTop10OrderedReport");

		if (document.forms["myHelperStorefrontActivityTop10Ordered"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperStorefrontActivityTop10Ordered"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","9");
		} else if (document.forms["myHelperStorefrontActivityTop10Ordered"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","12");
		}

		setReportFrameworkReportName("biStorefrontActivityTop10OrderedReport");
...
function ResetValues()
  ...
  function saveStatOption(container)
   ...
   function returnStatOptionResellerOrg(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("storefrontActivityTop10Ordered") %></h1>
   <%=biNLS.get("storefrontActivityTop10OrderedDescription") %>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperStorefrontActivityTop10Ordered>
