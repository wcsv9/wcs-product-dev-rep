...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><%=biNLS.get("storefrontActivityTop10Transferred")%></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		  ...
		  ResetValues();
		  onLoadStatOption("myHelperStorefrontActivityTop10Transferred");
       ...
       function savePanelData()
      {
		 ...
		 saveStatOption("myHelperStorefrontActivityTop10Transferred");
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report framework particulars
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biStorefrontActivityTop10TransferredReportOutputDialog");
         setReportFrameworkReportXML("bi.biStorefrontActivityTop10TransferredReport");

		if (document.forms["myHelperStorefrontActivityTop10Transferred"].rbsort[0].checked) {
			setReportFrameworkParameter("sortOrder","DESC");
		} else {
			setReportFrameworkParameter("sortOrder","ASC");
		}

		if (document.forms["myHelperStorefrontActivityTop10Transferred"].rbname[0].checked) {
			setReportFrameworkParameter("sortBy","7");
		} else if (document.forms["myHelperStorefrontActivityTop10Transferred"].rbname[1].checked) {
			setReportFrameworkParameter("sortBy","11");
		} else if (document.forms["myHelperStorefrontActivityTop10Transferred"].rbname[2].checked) {
			setReportFrameworkParameter("sortBy","1");
		}

		setReportFrameworkReportName("biStorefrontActivityTop10TransferredReport");
...
function ResetValues()
   ...
   function returnStatOptionPartNumber(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=biNLS.get("storefrontActivityTop10Transferred") %></h1>
   <%=biNLS.get("storefrontActivityTop10TransferredDescription") %>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<DIV ID=pageBody STYLE="display: block; margin-left:0">
		<FORM NAME=myHelperStorefrontActivityTop10Transferred>
							...
							<TR HEIGHT=5>
								<TD ALIGN=left VALIGN=TOP>
									...
									<INPUT TYPE=RADIO NAME=rbname VALUE=PayA id=s2>
										<label for= s2>
											<%=biNLS.get("resellerOrganization")%>
										</label>
									</INPUT>
									<BR>
									<BR>
