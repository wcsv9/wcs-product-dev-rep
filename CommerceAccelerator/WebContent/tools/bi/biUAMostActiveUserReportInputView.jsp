...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biUAMostActiveUserReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperUAMostActiveUser");
		 ResetValues();
      ...
      {
      	 saveStatOption("myHelperUAMostActiveUser");
         setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biUAMostActiveUserReportOutputDialog");
         setReportFrameworkReportXML("bi.biUAMostActiveUserReport");

			 if (document.forms["myHelperUAMostActiveUser"].rbsort[0].checked) {
				   setReportFrameworkParameter("sortOrder","DESC");
			 } else {
				   setReportFrameworkParameter("sortOrder","ASC");
			 }

		   if (document.forms["myHelperUAMostActiveUser"].rbname[0].checked) {
					 setReportFrameworkParameter("sortBy","2");
		   } else if (document.forms["myHelperUAMostActiveUser"].rbname[1].checked) {
					 setReportFrameworkParameter("sortBy","3");
		   }

		   setReportFrameworkReportName("biUAMostActiveUserReport");
   ...
   function returnSortByOptionMemberName(container) {
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biUAMostActiveUser") %></LABEL></h1>
	<LABEL><%=biNLS.get("biUAMostActiveUserDescription") %></LABEL>
	<p>

	<p></p>
   <LABEL><%=biNLS.get("biUAMostActiveUserReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-left:0">
		<FORM NAME=myHelperUAMostActiveUser>
		 ...
		 <TR>
		      <TD ALIGN=left VALIGN=TOP>
				<TABLE border=0 bordercolor=black CELLPADDING=0 CELLSPACING=0 width=200>
		         ...
		         <INPUT TYPE=RADIO NAME=rbname VALUE=All id=s1>
					<label for= s1>
		            <%=biNLS.get("memberNameSort")%></label>
				 </INPUT>
		         <BR>
		         <BR>
		      ...
		      <TD ALIGN=left VALIGN=TOP>
				<TABLE border=0 bordercolor=black CELLPADDING=0 CELLSPACING=0 width=200>
		         ...
		         <BR>
		         <BR>
		         <INPUT TYPE=RADIO NAME=rbsort VALUE=PayA id=ord2></label>
					<label for=  ord2>
