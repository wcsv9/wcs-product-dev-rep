...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biUAMostRequestedPagesReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperUAMostRequestedPages");
		 ResetValues();
      ...
      {
		 saveStatOption('myHelperUAMostRequestedPages');
		 setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biUAMostRequestedPagesReportOutputDialog");
         setReportFrameworkReportXML("bi.biUAMostRequestedPagesReport");

		   if (document.forms["myHelperUAMostRequestedPages"].rbsort[0].checked) {
				 setReportFrameworkParameter("sortOrder","DESC");
		   } else {
				 setReportFrameworkParameter("sortOrder","ASC");
		   }

		 setReportFrameworkReportName("biUAMostRequestedPagesReport");
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biUAMostRequestedPages") %></LABEL></h1>
	<LABEL><%=biNLS.get("biUAMostRequestedPagesDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biUAMostRequestedPagesReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-left:0">
		<FORM NAME=myHelperUAMostRequestedPages>
