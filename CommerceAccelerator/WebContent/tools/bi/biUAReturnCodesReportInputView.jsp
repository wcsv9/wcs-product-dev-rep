...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biUAReturnCodesReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperUAReturnCodes");
		 ResetValues();
      ...
      {
         saveStatOption('myHelperUAReturnCodes');
         setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biUAReturnCodesReportOutputDialog");
         setReportFrameworkReportXML("bi.biUAReturnCodesReport");

		   if (document.forms["myHelperUAReturnCodes"].rbsort[0].checked) {
				 setReportFrameworkParameter("sortOrder","DESC");
		   } else {
				 setReportFrameworkParameter("sortOrder","ASC");
		   }

		 setReportFrameworkReportName("biUAReturnCodesReport");
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biUAReturnCodes") %></LABEL></h1>
	<LABEL><%=biNLS.get("biUAReturnCodesDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biUAReturnCodesReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-left:0">
		<FORM NAME=myHelperUAReturnCodes>
