...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biUATopEntryPagesReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperUATopEntryPages");
		 ResetValues();
      ...
      {
		 saveStatOption('myHelperUATopEntryPages');
		 setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","bi.biUATopEntryPagesReportOutputDialog");
		 setReportFrameworkReportXML("bi.biUATopEntryPagesReport");


		   if (document.forms["myHelperUATopEntryPages"].rbsort[0].checked) {
				 setReportFrameworkParameter("sortOrder","DESC");
		   } else {
				 setReportFrameworkParameter("sortOrder","ASC");
		   }

		 setReportFrameworkReportName("biUATopEntryPagesReport");
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biUATopEntryPages") %></LABEL></h1>
	<LABEL><%=biNLS.get("biUATopEntryPagesDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biUATopEntryPagesReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-left:0">
		<FORM NAME=myHelperUATopEntryPages>
