...
<link rel=stylesheet href="<%= UIUtil.getCSSFile(biLocale) %>" type="text/css">
   ...
   <title><LABEL><%=biNLS.get("biUATopExitPagesReport")%></LABEL></title>
   ...
   <script>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperUATopExitPages");
		 ResetValues();
      ...
      {
 		 saveStatOption('myHelperUATopExitPages');
 		 setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","bi.biUATopExitPagesReportOutputDialog");
	     setReportFrameworkReportXML("bi.biUATopExitPagesReport");

 		   if (document.forms["myHelperUATopExitPages"].rbsort[0].checked) {
 				 setReportFrameworkParameter("sortOrder","DESC");
 		   } else {
 				 setReportFrameworkParameter("sortOrder","ASC");
 		   }

 		 setReportFrameworkReportName("biUATopExitPagesReport");
...
<body onload="initializeValues()" class="content">
	...
	<h1><LABEL><%=biNLS.get("biUATopExitPages") %></LABEL></h1>
	<LABEL><%=biNLS.get("biUATopExitPagesDescription") %></LABEL>
	<p></p>
   <LABEL><%=biNLS.get("biUATopExitPagesReportSelection")%></LABEL>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-center:5">
		<FORM NAME=myHelperUATopExitPages>
