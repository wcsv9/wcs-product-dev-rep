...
<% 
   try {
    ...
    // activate the itemDESC
    CatalogEntryDescriptionDataBean itemDesc = new CatalogEntryDescriptionDataBean();
    itemDesc.setInitKey_catalogEntryReferenceNumber(catEntryRefNum);
    itemDesc.setInitKey_language_id(languageId);
    DataBeanManager.activate(itemDesc, request); 

    String shortDesc = itemDesc.getShortDescription();
    String longDesc1 = itemDesc.getLongDescription();
    String longDesc2 = itemDesc.getAuxDescription1();
    String longDesc3 = itemDesc.getAuxDescription2();
...
<TITLE><%=UIUtil.toHTML((String)itemResource.get("Description"))%></TITLE>
...
<H1><%=UIUtil.toHTML((String)itemResource.get("Description"))%></H1> 
<FORM name="description">
<TABLE>
    <TH colspan="5"></TH>   
    <TR>
    	<TD COLSPAN="5">
    	    <LABEL for="shortDescID"><%=UIUtil.toHTML((String)itemResource.get("shortDesc"))%></LABEL>
    	</TD>
    </TR>
    <TR>
    	<TD COLSPAN="5">
    	    <INPUT id="shortDescID" size="58" maxlength="254" type="text" name="shortDesc"><BR><BR>
    	</TD>
    </TR> 
    <TR>
    	<TD COLSPAN=5>
    	    <LABEL for="longDescID"><%=UIUtil.toHTML((String)itemResource.get("longDesc"))%></LABEL>
    	</TD>
    </TR>
    <TR>
        <TD COLSPAN=5>
    ...
    <TR>
    	<TD COLSPAN=5>
    	    <LABEL for="auxDesc1ID"><%=UIUtil.toHTML((String)itemResource.get("auxDesc1"))%></LABEL>
    	</TD>
    </TR>
    <TR>
        <TD COLSPAN=5>
    ...
    <TR>
    	<TD COLSPAN=5>
    	    <LABEL for="auxDesc2ID"><%=UIUtil.toHTML((String)itemResource.get("auxDesc2"))%></LABEL>
    	</TD>
    </TR>
    <TR>
        <TD COLSPAN=5>
