...
ExtendedData extData = creditDataBean.getTranExtendedData();
...
<script language="JavaScript">
	...
	var ListDatas = new ListDate("credit");
...
<!--JSP File name :ppcEditCreditExtendedData.jsp -->
<H1><%=UIUtil.toHTML((String) ppcLabels.get("editPendingCreditExtendedData"))%></H1>
<SCRIPT>
