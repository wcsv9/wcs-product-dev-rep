...
<%
	...
	CommandContext tempCmdContext = (CommandContext)cmdContextLocale.clone();
   	/**
	 * Support for "customer shopping under different organizations".
	 * IBM internal use only for switching user and active organization id in command
	 * context.
	 */
	if (selectedOrgId != null) {
		tempCmdContext.setStickyActiveOrganizationId(new Long(selectedOrgId));
	}
	...
	pList.setCommandContext(tempCmdContext);
