...
<html>
  <head>
	...
	*******************************/
	...
	function addPackage()
	{
		...
		if (defined(document.addForm["<%= OrderConstants.EC_ATTR_NAME %>"])) {
			var attributes = new Vector();
			var numberOfAttributes = document.addForm["<%= OrderConstants.EC_ATTR_NAME %>"].length;
  ...
  <p><%= (String)orderAddProducts.get("addProductPagePackageDetailsDescription") %></p>    
...
<form name="addProduct" method="post" action="CSROrderItemAdd">
	<input type='hidden' name="XML" value=""> 
	     ...
	     value="OrderAddProductPackageDetailsB2B" />
