...
<html>
  ...
  <p><%= (String)orderAddProducts.get("addProductPageProductDetailsDescription") %>    
	...
	<input type="hidden" name="<%= ECConstants.EC_ERROR_VIEWNAME %>" value="OrderAddProductProductDetailsB2C" />
