...
<html>
  ...
  <body class="content">
    ...
    <input type="hidden" name="XMLFile" value="order.orderProductListDialogB2C" />
    <input type="hidden" name="ActionXMLFile" value="order.orderProductListB2C" />
    <input type="hidden" name="cmd" value="OrderProductListB2C" />
