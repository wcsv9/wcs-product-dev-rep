...
%> 
<label for="WC_COD_FormInput_piAmount"></label>
<input type="hidden" name="piAmount" value="<%=edp_OrderTotalAmount%>" id="WC_COD_FormInput_piAmount" />
<!-- table cellpadding="3" cellspacing="0" border="0" id="WC_CustomOfflineCOD_Table_1">  
<tr>
  <td  valign="middle" id="WC_CustomOfflineCOD_TableCell_1"><%//=shortDescription%></td>
</tr>
</table-->
<%}else{%>                    
