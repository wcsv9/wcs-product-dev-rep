...
//System.out.println("paymentTCId in discover:"+paymentTCId );
...
//System.out.println("account in discover:"+account);
...
<table cellpadding="3" cellspacing="0" border="0" id="StandardDiscover_Table_1">
	<tr>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_11">
			<label for="StandardDiscover_InputText_1">
				<span class="required">*</span>
				 <%= UIUtil.toHTML( (String)resourceBundle.get("cardNumber")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_12">
			<input type="text" name="account" value="<%=account%>" id="StandardDiscover_InputText_1" 
			...
			<% if("true".equals(showPONumber)){%> <input type="hidden" name="purchaseorder_id" value="<%=purchaseorder_id%>" id="StandardDiscover_InputText_2" /> <%}%> 				
		</td>
	</tr>
	<tr>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_21">
			<label for="edp_Discover_cardExpiryMonth">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("cardExpireMonth")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_22">
			<select name="expire_month" size=1 id="edp_Discover_cardExpiryMonth">
	...
	<tr>	
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_31">
			<label for="edp_Discover_cardExpiryYear">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("cardExpiryYear")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_32">
			<select name="expire_year" size=1 id="edp_Discover_cardExpiryYear">
	...
	<tr>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_41">
			<label for="StandardDiscover_InputText_2">
				<%= UIUtil.toHTML( (String)resourceBundle.get("cvv2Number")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_42">
			<input type="text" name="cc_cvc" value="<%=cc_cvc%>" id="StandardDiscover_InputText_2" />
		</td>
	</tr>
	
	<tr>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_61">
			<label for="StandardDiscover_InputText_4">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("paymentInstructionAmount"))%>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_62">
			<input type="text" name="piAmount" value="<%=edp_PayMethodAmount%>" id="StandardDiscover_InputText_4" />
		</td>
	</tr>		
	<%// load billing address dropdown box from a seperate page %>
	
	<tr>
		<td colspan="4" valign="middle" id="StandardDiscover_TableCell_72">
...
<%} else {%>
<INPUT TYPE=hidden  name="<%= ECConstants.EC_CC_BRAND %>" VALUE="Discover" >
