...
<table cellpadding="3" cellspacing="0" border="0" id="StandardMaster_Table_1">
	<tr>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_11">
			<label for ="StandardMaster_InputText_1">
				<span class="required">*</span>
				<%=UIUtil.toHTML((String)resourceBundle.get("cardNumber"))%>
			</label>
			
		</td>	
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_12">
			<input type="text" name="account" value="<%=account%>" id="StandardMaster_InputText_1" 
			...
			<% if("true".equals(showPONumber)){%> <input type="hidden" name="purchaseorder_id" value="<%=purchaseorder_id%>" id="StandardMaster_InputText_2" /> <%}%> 		
		</td>
	</tr>
	<tr>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_21">
			<label for="edp_Master_cardExpiryMonth"><span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("cardExpireMonth")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_22">
	...
	<tr>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_31">
			<label for="edp_Master_cardExpiryYear">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("cardExpiryYear"))%>
			</label>
		</td>	
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_32">
	...
	<tr>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_33">
			<label for="StandardMaster_InputText_3"><span class="required">*</span>
			<%= UIUtil.toHTML( (String)resourceBundle.get("paymentInstructionAmount"))%></label>
		</td>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_34">
			<input type="text" name = "piAmount" value="<%=edp_PayMethodAmount%>" id="StandardMaster_InputText_3" />
		</td>
	</tr>
		<%-- load billing address dropdown box from a seperate page --%>
	<tr>
		<td colspan="4" valign="middle" id="StandardMaster_TableCell_36">
...
<%} else {%>
<INPUT TYPE=hidden  name="<%= ECConstants.EC_CC_BRAND %>" VALUE="MasterCard" >
