...
//System.out.println("paymentTCId in visa:"+paymentTCId );
...
//System.out.println("account in visa:"+account);
...
<table cellpadding="3" cellspacing="0" border="0" id="StandardVisa_Table_1">
	<tr>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_11">
			<label for="StandardVisa_InputText_1">
				<span class="required">*</span>
				 <%= UIUtil.toHTML( (String)resourceBundle.get("cardNumber")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_12">
			<input type="text" name="account" value="<%=account%>" id="StandardVisa_InputText_1" 
			...
			<% if("true".equals(showPONumber)){%> <input type="hidden" name="purchaseorder_id" value="<%=purchaseorder_id%>" id="StandardVisa_InputText_2" /> <%}%> 				
		</td>
	</tr>
	<tr>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_21">
			<label for="edp_Visa_cardExpiryMonth">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("cardExpireMonth")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_22">
	...
	<tr>	
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_31">
			<label for="edp_Visa_cardExpiryYear">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("cardExpiryYear")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_32">
	...
	<tr>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_41">
			<label for="StandardVisa_InputText_2">
				<%= UIUtil.toHTML( (String)resourceBundle.get("cvv2Number")) %>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_42">
			<input type="text" name="cc_cvc" value="<%=cc_cvc%>" id="StandardVisa_InputText_2" />
		</td>
	</tr>
	
	<tr>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_61">
			<label for="StandardVisa_InputText_4">
				<span class="required">*</span>
				<%= UIUtil.toHTML( (String)resourceBundle.get("paymentInstructionAmount"))%>
			</label>
		</td>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_62">
			<input type="text" name="piAmount" value="<%=edp_PayMethodAmount%>" id="StandardVisa_InputText_4" />
		</td>
	</tr>		
	<%// load billing address dropdown box from a seperate page %>
	
	<tr>
		<td colspan="4" valign="middle" id="StandardVisa_TableCell_72">
...
<%} else {%>
<INPUT TYPE=hidden  name="<%= ECConstants.EC_CC_BRAND %>" VALUE="VISA" >
