...
<!--
    ...
    <TR>
      <TD><label for="payment"><%= resourceBundle.get("cardholderName") %></label></TD>
      <TD>     	
        <INPUT TYPE="TEXT" NAME="Ecom_Payment_Card_Name" ID="payment" SIZE="20" MAXLENGTH="64">
      </TD>
      <TD></TD>
    </TR>
    <TR>
    ...
    <TR>
      <TD><label for="postalCode"><%= resourceBundle.get("avsPostalCode") %></label></TD>
      <TD>     	
        <INPUT TYPE="TEXT" NAME="Ecom_BillTo_Postal_PostalCode" ID="postalCode" SIZE="14" MAXLENGTH="14">
      </TD>
      <TD></TD>
    </TR>
    <TR>
