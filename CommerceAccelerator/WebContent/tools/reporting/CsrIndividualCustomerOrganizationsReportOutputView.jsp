...
<%
    String reportPrefix = "CsrActiveAccountsB2B";
%>
...
<HTML>
   ...
   <BODY CLASS=content ONLOAD="javascript:parent.setContentFrameLoaded(true)">	
	...
	<%=generateIndividualCustomerOrganizationsSpecificCSROutputInputCriteria(reportPrefix, reportsRB, reportsCommandContext.getLocale())%>
