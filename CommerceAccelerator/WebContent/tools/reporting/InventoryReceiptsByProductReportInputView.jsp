<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
 InventoryReceiptsByProductReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("InventoryReceiptsByProductReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.InventoryReceiptsByProductReportOutputDialog");
         setReportFrameworkReportXML("reporting.InventoryReceiptsByProductReport");
         if (allProductsSelectedTF("myProducts")) setReportFrameworkReportName("InventoryReceiptsByProductReportAllProducts");
         else                                     setReportFrameworkReportName("InventoryReceiptsByProductReport");

         ////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report specific parameters and save
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         if (allProductsSelectedTF("myProducts")) setReportFrameworkParameter("ItemsSelected","<%=reportsRB.get("InventoryReceiptsByProductReportAllItemsSelectedTitle")%>");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("InventoryReceiptsByProductReportInputViewTitle") %></H1>
   <%=reportsRB.get("InventoryReceiptsByProductReportDescription")%>
   <p>

   <DIV ID=pageBody STYLE="display: block; margin-left: 20">
      <%=generateStartDateEndDate("enquiryPeriod", reportsRB, null)%>
      <%=generateSelectProducts("myProducts", reportsRB, "InventoryReceiptsByProductReportSelectProductsTitle")%>
