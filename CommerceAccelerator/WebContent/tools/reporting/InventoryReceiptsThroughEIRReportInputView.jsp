<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
 InventoryReceiptsThroughEIRReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("InventoryReceiptsThroughEIRReportInputView1Title")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.InventoryReceiptsThroughEIRReportOutputDialog");
         setReportFrameworkReportXML("reporting.InventoryReceiptsThroughEIRReport");
         if (allProductsSelectedTF("myProducts")) setReportFrameworkReportName("InventoryReceiptsThroughEIRReportAllProducts");
         else                                     setReportFrameworkReportName("InventoryReceiptsThroughEIRReport");

         ////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report specific parameters and save
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         if (allProductsSelectedTF("myProducts")) setReportFrameworkParameter("ItemsSelected","<%=reportsRB.get("InventoryReceiptsThroughEIRReportAllItemsSelectedTitle")%>");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("InventoryReceiptsThroughEIRReportInputViewTitle") %></H1>
   <%=reportsRB.get("InventoryReceiptsThroughEIRReportDescription")%>
   <p>

   <DIV ID=pageBody STYLE="display: block; margin-left: 20">
      <%=generateStartDateEndDate("enquiryPeriod", reportsRB, null)%>
      <%=generateSelectProducts("myProducts", reportsRB, "InventoryReceiptsThroughEIRReportSelectProductsTitle")%>
