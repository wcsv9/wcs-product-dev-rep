...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("ManifestedOrdersReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.ManifestedOrdersReportOutputDialog");
         setReportFrameworkReportXML("reporting.ManifestedOrdersReportComplexOrders");
         setReportFrameworkReportName("ManifestedOrdersReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("ManifestedOrdersReportInputViewTitle") %></H1>
   <%=reportsRB.get("ManifestedOrdersReportDescription")%>
   <p>
