...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("NewCompanyRegistrationReportWindowTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperNewCompanyRegistration");
		 ResetValues();
      ...
      {
		 saveStatOption("myHelperNewCompanyRegistration");
		 setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","reporting.NewCompanyRegistrationReportOutputDialog");
		 setReportFrameworkReportXML("reporting.NewCompanyRegistrationReport");

			  if (document.forms["myHelperNewCompanyRegistration"].rbsort[0].checked) {
					 setReportFrameworkParameter("sortOrder","DESC");
			  } else {
					 setReportFrameworkParameter("sortOrder","ASC");
			  }

			  if (document.forms["myHelperNewCompanyRegistration"].rbname[0].checked) {
					 setReportFrameworkParameter("sortBy","3");
			  } else if (document.forms["myHelperNewCompanyRegistration"].rbname[1].checked) {
					 setReportFrameworkParameter("sortBy","8");
			  } else if (document.forms["myHelperNewCompanyRegistration"].rbname[2].checked) {
					 setReportFrameworkParameter("sortBy","9");
			  }

			  setReportFrameworkReportName("NewCompanyRegistrationReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("NewCompanyRegistrationReportWindowTitle") %></H1>
   <%=reportsRB.get("NewCompanyRegistrationReportDescription")%>
   <p></p>
   <%=reportsRB.get("NewCompanyRegistrationReportSelection")%>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-center:5">
		<FORM NAME="myHelperNewCompanyRegistration">
