...
<HEAD>
   <%=fHeader%>
   <TITLE><%=reportsRB.get("NewIndividualsRegistrationReportWindowTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function initializeValues()
      {
		 ...
		 onLoadSortOrderByOption("myHelperNewIndividualRegistration");
		 ResetValues();
      ...
      {
		 saveStatOption("myHelperNewIndividualRegistration");
		 setReportFrameworkOutputView("DialogView");
		 setReportFrameworkParameter("XMLFile","reporting.NewIndividualsRegistrationReportOutputDialog");
		 setReportFrameworkReportXML("reporting.NewIndividualsRegistrationReport");

		  if (document.forms["myHelperNewIndividualRegistration"].orderBy[0].checked) {
				 setReportFrameworkParameter("sortOrder","DESC");
		  } else {
				 setReportFrameworkParameter("sortOrder","ASC");
		  }

		  if (document.forms["myHelperNewIndividualRegistration"].sortBy[0].checked) {
				 setReportFrameworkParameter("sortBy","2");
		  } else if (document.forms["myHelperNewIndividualRegistration"].sortBy[1].checked) {
				 setReportFrameworkParameter("sortBy","7");
		  } else if (document.forms["myHelperNewIndividualRegistration"].sortBy[2].checked) {
				 setReportFrameworkParameter("sortBy","8");
		  }

		  setReportFrameworkReportName("NewIndividualsRegistrationReport");
   ...
   function returnSortByOptionLastName(container) {
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("NewIndividualsRegistrationReportWindowTitle") %></H1>
   <%=reportsRB.get("NewIndividualsRegistrationReportDescription")%>
   <p></p>
   <%=reportsRB.get("NewIndividualsRegistrationReportSelection")%>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-center:5">
		<FORM NAME="myHelperNewIndividualRegistration">
