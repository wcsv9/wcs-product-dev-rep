...
<SCRIPT>
	function getHelp()
	{
		return "MC.reporting.OperationalReportsHomeView.Help";
	}
</SCRIPT>
...
<table CELLPADDING="0" CELLSPACING="0" BORDER="0" HEIGHT="100%" WIDTH="100%">
    <tr>
        ...
        <table CELLPADDING="0" CELLSPACING="0" BORDER="0" WIDTH="100%" HEIGHT="1%">
            ...
            <tr>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="/webapp/wcs/tools/servlet/DialogView?XMLFile=reporting.StoreActivityReportDialog"><%=resourceBundle.get("OpReportsStoreActivityReportTitle")%></a></td>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td class="entry_text"><%=resourceBundle.get("OpReportsStoreActivityReportDescription")%></td>
            </tr>
            <tr>
                <td CLASS="entry_space" COLSPAN=4>&nbsp;&nbsp;&nbsp;</td>
            </tr>
            ...
            <tr>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="javascript:top.setContent('<%=resourceBundle.get("ReviewIndividualCustomerActivity")%>', '/webapp/wcs/tools/servlet/ReviewIndividualCustomerActivityView', true, null)"><%=resourceBundle.get("ReviewIndividualCustomerActivityTitle")%></a></td>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td class="entry_text"><%=resourceBundle.get("ReviewIndividualCustomerActivityDescription")%></td>
            </tr>
			<tr>
                <td CLASS="entry_space" COLSPAN=4>&nbsp;&nbsp;&nbsp;</td>
            </tr>
            ...
            <tr>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="javascript:top.setContent('<%=resourceBundle.get("ReviewFailedUsersLogon")%>', '/webapp/wcs/tools/servlet/DialogView?XMLFile=reporting.ReviewFailedUsersLogonReportInputDialog', true, null)"><%=resourceBundle.get("ReviewFailedUsersLogon")%></a></td>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td class="entry_text"><%=resourceBundle.get("ReviewFailedUsersLogonReportDescription")%></td>
            </tr>
			<tr>
                <td CLASS="entry_space" COLSPAN=4>&nbsp;&nbsp;&nbsp;</td>
            </tr>
	    ...
	    <tr>
                <td CLASS="entry_space">&nbsp;&nbsp;&nbsp;</td>
                <td NOWRAP class="entry_text"><a href="javascript:top.setContent('<%=resourceBundle.get("ReviewContracts")%>', '/webapp/wcs/tools/servlet/ReviewContractsView', true, null)"><%=resourceBundle.get("ReviewContractsTitle")%></a></td>
                <td>&nbsp;&nbsp;&nbsp;</td>
                <td class="entry_text"><%=resourceBundle.get("ReviewContractsDescription")%></td>
            </tr>            
        </table>
        </td>
    </tr>
