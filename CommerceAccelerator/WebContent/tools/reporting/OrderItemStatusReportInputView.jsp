...
<HEAD>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.OrderItemStatusReportOutputDialog");
         setReportFrameworkReportXML("reporting.OrderItemStatusReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <DIV ID=pageBody STYLE="display: block; margin-left: 20">
      ...
      <%=generateStatOption("myHelperOrderStatus", reportsRB, "OrderItemStatusReportOptionTitle")%>
   </DIV>
