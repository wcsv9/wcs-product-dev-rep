...
//*
 -----------------------------------------------------------------------------
 OrderByAccountReportInputView.jsp
 ===========================================================================-->
...
<head>
   ...
   <title><%=reportsRB.get("OrderByAccountReportInputViewTitle")%></title>
   ...
   <script>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.OrdersByAccountReportOutputDialog");
         setReportFrameworkReportXML("reporting.OrdersByAccountReport");
	 setReportFrameworkReportName("OrderByAccountReport");
...
<body ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=reportsRB.get("OrderByAccountReportInputViewTitle") %></h1>
   <i><%=reportsRB.get("OrderByAccountReportDescription")%></i>
    <p>
