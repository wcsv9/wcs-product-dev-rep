<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
 ProductSalesReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("ProductSalesReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.ProductSalesReportOutputDialog");
         setReportFrameworkReportXML("reporting.ProductSalesReport");
         setReportFrameworkReportName("ProductSalesReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("ProductSalesReportInputViewTitle") %></H1>
   <%=reportsRB.get("ProductSalesReportDescription")%>
   <p>
