<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
RegionAllStoresReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("RegionAllStoresReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.RegionAllStoresReportOutputDialog");
         setReportFrameworkReportXML("reporting.RegionAllStoresReport");
         setReportFrameworkReportName("RegionAllStoresReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("RegionAllStoresReportInputViewTitle") %></H1>
   <%=reportsRB.get("RegionAllStoresReportDescription")%>
   <p>
