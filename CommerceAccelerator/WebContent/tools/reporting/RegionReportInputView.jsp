...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("RegionReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.RegionReportOutputDialog");
         setReportFrameworkReportXML("reporting.RegionReport");
         setReportFrameworkReportName("RegionReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("RegionReportInputViewTitle") %></H1>
   <%=reportsRB.get("RegionReportDescription")%>
   <p>
