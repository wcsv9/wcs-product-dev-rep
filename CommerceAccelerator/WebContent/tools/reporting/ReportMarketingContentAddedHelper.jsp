   ...
   String result =        "<FORM NAME=" + container + ">\n" +
                            ...
                            "            <BR>\n" +
                                              "            <INPUT TYPE=RADIO NAME=rbname VALUE=PayA id=s2>\n" +
													"<label for= s2>" +
                                              "               " + biNLS.get("numTimesViewed") + "\n </label> " +
                                              "                      </INPUT>\n" +
                                              "            <BR>\n" +       
                            "            <BR>\n" +
                                              "            <INPUT TYPE=RADIO NAME=rbname VALUE=PayA id=s3>\n" +
													 "<label for= s3>" +
                                              "               " + biNLS.get("noAddToShopcart") + "\n </label> " +
                                              "                      </INPUT>\n" +
                                                 "            <BR>\n" +       
                                              "         </TD>\n" +
                                              "      </TR>\n" +
...
<SCRIPT>
   ...
   function returnStatOptionInitiativeName(container) {
      return document.forms[container].rbname[0].checked;
   }
   function returnStatOptionNoofTimesViewed(container) {
      return document.forms[container].rbname[1].checked;
   }
   function returnStatOptionNoofTimesAddedtoShopCart(container) {
