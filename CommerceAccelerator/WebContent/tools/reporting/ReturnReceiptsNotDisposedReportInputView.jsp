<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
 ReturnReceiptsNotDisposedReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("ReturnReceiptsNotDisposedReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.ReturnReceiptsNotDisposedReportOutputDialog");
         setReportFrameworkReportXML("reporting.ReturnReceiptsNotDisposedReport");
         if (allProductsSelectedTF("myProducts")) setReportFrameworkReportName("ReturnReceiptsNotDisposedReportAllProducts");
         else                                     setReportFrameworkReportName("ReturnReceiptsNotDisposedReport");

         ////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report specific parameters and save
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         if (allProductsSelectedTF("myProducts")) setReportFrameworkParameter("ItemsSelected","<%=reportsRB.get("ReturnReceiptsNotDisposedReportAllItemsSelectedTitle")%>");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("ReturnReceiptsNotDisposedReportInputViewTitle") %></H1>
   <%=reportsRB.get("ReturnReceiptsNotDisposedReportDescription")%>
   <p>

   <DIV ID=pageBody STYLE="display: block; margin-left: 20">
      <%=generateStartDateEndDate("enquiryPeriod", reportsRB, null)%>
      <%=generateSelectProducts("myProducts", reportsRB, "ReturnReceiptsNotDisposedReportSelectProductsTitle")%>
