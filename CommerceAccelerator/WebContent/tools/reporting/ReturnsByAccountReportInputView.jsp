...
//*
 -----------------------------------------------------------------------------
 ReturnsByAccountReportInputView.jsp
 ===========================================================================-->
...
<head>
   ...
   <title><%=reportsRB.get("ReturnsByAccountReportInputViewTitle")%></title>
   ...
   <script>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.ReturnsByAccountReportOutputDialog");
         setReportFrameworkReportXML("reporting.ReturnsByAccountReport");
         setReportFrameworkReportName("ReturnsByAccountReport");
...
<body ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=reportsRB.get("ReturnsByAccountReportInputViewTitle") %></h1>
   <i><%=reportsRB.get("ReturnsByAccountReportDescription")%></i>
   <p>
...
%>
      <%=generateAccounts("myAccounts", reportsRB, "ReturnsByAccountReportSelectAccountsTitle")%>
<%    }
%>
   </div>
