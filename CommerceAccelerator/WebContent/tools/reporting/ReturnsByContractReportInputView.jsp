...
//*
 -----------------------------------------------------------------------------
 ReturnsByContractReportInputView.jsp
 ===========================================================================-->
...
<head>
   ...
   <title><%=reportsRB.get("ReturnsByContractReportInputViewTitle")%></title>
   ...
   <script>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.ReturnsByContractReportOutputDialog");
         setReportFrameworkReportXML("reporting.ReturnsByContractReport");
         setReportFrameworkReportName("ReturnsByContractReport");
...
<body ONLOAD="initializeValues()" CLASS=content>
   ...
   <h1><%=reportsRB.get("ReturnsByContractReportInputViewTitle") %></h1>
   <i><%=reportsRB.get("ReturnsByContractReportDescription")%></i>
   <p>
...
%>
      <%=generateContracts("myContracts", reportsRB, "ReturnsByContractReportSelectContractsTitle")%>
<%    }
%>
   </div>
