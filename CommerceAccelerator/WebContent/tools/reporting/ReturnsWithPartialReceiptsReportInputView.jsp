<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
 ReturnsWithPartialReceiptsReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("ReturnsWithPartialReceiptsReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.ReturnsWithPartialReceiptsReportOutputDialog");
         setReportFrameworkReportXML("reporting.ReturnsWithPartialReceiptsReport");
         setReportFrameworkReportName("ReturnsWithPartialReceiptsReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("ReturnsWithPartialReceiptsReportInputViewTitle") %></H1>
   <%=reportsRB.get("ReturnsWithPartialReceiptsReportDescription")%>
   <p>
