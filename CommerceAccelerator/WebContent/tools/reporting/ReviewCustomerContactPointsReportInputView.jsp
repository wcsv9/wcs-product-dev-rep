...
<%@include file="ReportReviewCustomerContactHelper.jsp" %>

<HTML>
<HEAD>
   <%=fHeader%>

   <TITLE><%=reportsRB.get("ReviewCustomerContactPointsReportWindowTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function initializeValues() 
      {
         ...
         onLoadSortOrderByOption("myHelperReviewCustomerContact");
		 ResetValues();
      ...
      function savePanelData() 
      {
         ...
         ////////////////////////////////////////////////////////////////////////////////////////////////////
		 saveSortOrderByOption("myHelperReviewCustomerContact");
         setReportFrameworkOutputView("DialogView");
		setReportFrameworkParameter("XMLFile","reporting.ReviewCustomerContactPointsReportOutputDialog");
         setReportFrameworkReportXML("reporting.ReviewCustomerContactPointsReport");
		if(document.all.time.selectedIndex != 0)
		{
		////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report framework particulars
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         if(returnSortByOptionDate("myHelperReviewCustomerContact")){
			 if(returnOrderbyDesc("myHelperReviewCustomerContact")){
				 setReportFrameworkReportName("ReviewCustomerContactPointsReport" + document.all.time[document.all.time.selectedIndex].value+"Date");
			 }
			 else{
				 setReportFrameworkReportName("ReviewCustomerContactPointsReport" + document.all.time[document.all.time.selectedIndex].value+"DateAscend");
			 }
		 }
		 else{
			 if(returnOrderbyDesc("myHelperReviewCustomerContact")){
				 setReportFrameworkReportName("ReviewCustomerContactPointsReport" + document.all.time[document.all.time.selectedIndex].value+"Time");
			 }
			 else{
				 setReportFrameworkReportName("ReviewCustomerContactPointsReport" + document.all.time[document.all.time.selectedIndex].value+"TimeAscend");
			 }
		 }
		...
		{	
         ...
         if(returnSortByOptionDate("myHelperReviewCustomerContact")){
			 if(returnOrderbyDesc("myHelperReviewCustomerContact")){
				 setReportFrameworkReportName("ReviewCustomerContactPointsReportDate");
			 }
			 else{
				 setReportFrameworkReportName("ReviewCustomerContactPointsReportDateAscend");
			 }
		 }
		 else{
			 if(returnOrderbyDesc("myHelperReviewCustomerContact")){
				 setReportFrameworkReportName("ReviewCustomerContactPointsReportTime");
			 }
			 else{
				 setReportFrameworkReportName("ReviewCustomerContactPointsReportTimeAscend");
			 }
		 } 		           
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("ReviewCustomerContactPointsReportWindowTitle") %></H1>
   <%=reportsRB.get("ReviewCustomerContactPointsReportDescription")%>
   	...
   	<FORM NAME="UserId">
		<TABLE CELLPADDING=0 CELLSPACING=0>
         <TR HEIGHT=25>
            ...
            <TD WIDTH=10>&nbsp;</TD>
            <TD COLSPAN=4 VALIGN=TOP>
            <TD><LABEL for="uid"> </LABEL> <INPUT TYPE=TEXT NAME=EnterUserId id="uid"  SIZE=12 MAXLENGTH=32>&nbsp;</TD>
            </TR>
	       </TABLE>
		  <BR><BR>
		</Form>
   ...
   <p></p>
   <%=reportsRB.get("ReviewCustomerContactPointsReportSelection")%>
   <p>
...
<table border="0" bordercolor="black" CELLPADDING="0" CELLSPACING="0">
	...
	<div id=pageBody style="display: block; margin-center:5">
		<%=generateSortOrderByOption("myHelperReviewCustomerContact", reportsRB)%>
	</div>
