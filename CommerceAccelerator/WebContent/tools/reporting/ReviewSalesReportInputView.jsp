...
<%@include file="ReportReviewOrderByHelper.jsp" %>

<HTML>
<HEAD>
   <%=fHeader%>

   <TITLE><%=reportsRB.get("SalesReportWindowTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         ////////////////////////////////////////////////////////////////////////////////////////////////////
		 saveSortOrderByOption("myHelperReviewSales");
         setReportFrameworkOutputView("DialogView");
         setReportFrameworkParameter("XMLFile","reporting.ReviewSalesReportOutputDialog");
         setReportFrameworkReportXML("reporting.ReviewSalesReport");
		if(document.all.time.selectedIndex != 0)
		{
		////////////////////////////////////////////////////////////////////////////////////////////////////
         // Specify the report framework particulars
         ////////////////////////////////////////////////////////////////////////////////////////////////////
         if(returnOrderbyDesc("myHelperReviewSales")){
				 setReportFrameworkReportName("SalesReport" + document.all.time[document.all.time.selectedIndex].value);
		}
		else{
				 setReportFrameworkReportName("SalesReport" + document.all.time[document.all.time.selectedIndex].value+"Ascend");
		}
		...
		{	
         ...
         ////////////////////////////////////////////////////////////////////////////////////////////////////
      	 if(returnOrderbyDesc("myHelperReviewSales")){
				 setReportFrameworkReportName("SalesReport");
		}
		else{
				 setReportFrameworkReportName("SalesReportAscend");
		}     
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("SalesReportWindowTitle") %></H1>
   <%=reportsRB.get("SalesReportDescription")%>
   ...
   <p></p>
   <%=reportsRB.get("SalesReportSelection")%>
   <p>
  ...
  <B><%=reportsRB.get("or")%></B>
   ...
   <br>
	...
	<div id=pageBody style="display: block; margin-center:5">
		<%=generateSortOrderByOption("myHelperReviewSales", reportsRB)%>
	</div>
