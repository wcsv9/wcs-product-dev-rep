<!-- ========================================================================
 ...
 -----------------------------------------------------------------------------
 StoreActivityReportInputView.jsp
 ===========================================================================-->
...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("StoreActivityReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.StoreActivityReportOutputDialog");
         setReportFrameworkReportXML("reporting.StoreActivityReport");
         setReportFrameworkReportName("StoreActivityReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("StoreActivityReportInputViewTitle") %></H1>
   <%=reportsRB.get("StoreActivityReportDescription")%>
   <p>
