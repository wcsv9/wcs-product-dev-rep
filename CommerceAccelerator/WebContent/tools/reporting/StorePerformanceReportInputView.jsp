...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("StorePerformanceReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.StorePerformanceReportOutputDialog");
         setReportFrameworkReportXML("reporting.StorePerformanceReport");
         setReportFrameworkReportName("StorePerformanceReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("StorePerformanceReportInputViewTitle") %></H1>
   <%=reportsRB.get("StorePerformanceReportDescription")%>
   <p>
