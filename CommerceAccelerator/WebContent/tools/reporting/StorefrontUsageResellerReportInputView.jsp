...
<HEAD>
   ...
   <TITLE><%=reportsRB.get("StorefrontUsageResellerReportInputViewTitle")%></TITLE>
   ...
   <SCRIPT>
      ...
      function savePanelData() 
      {
         ...
         setReportFrameworkParameter("XMLFile","reporting.StorefrontUsageResellerReportOutputDialog");
         setReportFrameworkReportXML("reporting.StorefrontUsageResellerReport");
         setReportFrameworkReportName("StorefrontUsageResellerReport");
...
<BODY ONLOAD="initializeValues()" CLASS=content>
   ...
   <H1><%=reportsRB.get("StorefrontUsageResellerReportInputViewTitle") %></H1>
   <%=reportsRB.get("StorefrontUsageResellerReportDescription")%>
   <p>
