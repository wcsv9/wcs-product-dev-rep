...
<TR class="list_roles">
	...
	<TH><TABLE CLASS="list_role_off"><TR><TD class="list_header"><%= (String)returnsNLS.get("refundAmount2") %></TD></TR></TABLE></TH>
</TR>
<%
...
<TR>
	<TD align=right style="width: 88%"><B><%= UIUtil.toHTML(((String)returnsNLS.get("returnRefundTotalLabel"))+" ["+summary.getCurrency()+"]" )%></B></TD>
