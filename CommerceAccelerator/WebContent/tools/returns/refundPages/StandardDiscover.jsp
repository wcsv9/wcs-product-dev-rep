...
<TABLE border = "0">
    ...
    <TR>
      ...
      <TD ALIGN="left">&nbsp;&nbsp;&nbsp;</TD>
      <TD ALIGN="left"><LABEL for="INPUT4"><%= UIUtil.toHTML( (String)resourceBundle.get("cvvNumberLabel")) %></LABEL></TD>
    </TR>
    
    <TR>
      <TD>
        <INPUT TYPE=text SIZE=30 MAXLENGTH=256 NAME="<%= ECConstants.EC_CC_NUMBER %>" ID="INPUT1" VALUE="" >
      </TD>
      <TD ALIGN="left">&nbsp;&nbsp;&nbsp;</TD>
      <TD>       
      ...
      <TD ALIGN="left">&nbsp;&nbsp;&nbsp;</TD>
      <TD>
      	<INPUT TYPE=text SIZE=30 MAXLENGTH=256 NAME="<%= ECConstants.EC_CCV_CODE %>" ID="INPUT4" VALUE="" >
      </TD>
    </TR>
</TABLE>
