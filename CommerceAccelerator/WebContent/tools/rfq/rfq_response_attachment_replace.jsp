...
function retrievePanelData() {
    ...
    // form.filename.value = anAttachment.attachFilename;
}
...
<h1> <%= rfqNLS.get("replaceattachment") %> </h1>
<%= rfqNLS.get("instruction_Attachment_replace") %>
<br />
<p></p>
<table>
    <tr>
	...
	<i>
	<script type="text/javascript">
	    document.write(anAttachment.attachDescription);
	</script>
	</i>
	</td>
    </tr>
    <tr>
        <td><%= rfqNLS.get("filename") %>:
	<i>
	<script type="text/javascript">
	    document.write(anAttachment.attachFilename);
	</script>
	</i>
	</td>
    </tr>
...
<table>
    <tr>
        <td align="center"><%= rfqNLS.get("addrfqattachment") %></td>
    </tr>
</table>
<br />
<p></p>
<input type="hidden" name="XMLFile" value="rfq.rfqResponseAttachmentReplace" />
