...
<script type="text/javascript">
    ...
    allProducts = top.getData("allPercentagePricingProducts", 1);
    ...
    function savePanelData() 
    {
    	...
    	top.sendBackData(allProducts, "allPercentagePricingProducts");
    }
    ...
    function retrievePanelData() 
    {
        var priceAdjustment = anProduct.<%= RFQConstants.EC_OFFERING_PRICEADJUSTMENT %>;
       	...
       	{
       	    document.rfqProductPPForm.priceAdjustment.value = numberToStr((priceAdjustment * -1), <%= languageId %>, null);
        }
      	if (endresult_to_contract == false) 
      	{	
      	    document.rfqProductPPForm.quantity.value = anProduct.product_res_quantity;
      	}
    }
