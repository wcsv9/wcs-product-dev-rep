...
<script type="text/javascript">
    ...
    allProducts = top.getData("allFixedPricingProducts", 1);
	...
	var form = document.rfqProductForm;
	...
	top.sendBackData(allProducts, "allFixedPricingProducts");
    }
    ...
    {
      	document.rfqProductForm.price.value = anProduct.product_res_price;
      	document.rfqProductForm.quantity.value = anProduct.product_res_quantity;
    }
...
<%= rfqNLS.get("instruction_PDresponse") %>
