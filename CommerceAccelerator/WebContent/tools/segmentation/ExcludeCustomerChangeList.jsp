...
function removeCustomers () {
	...
	if (checked.length > 0) {
		if (confirmDialog("<%= UIUtil.toJavaScript((String) segmentsRB.get(SegmentConstants.MSG_CUSTOMER_LIST_REMOVE_CONFIRMATION)) %>")) {
			...
			var url = "<%= SegmentConstants.URL_SEGMENT_REMOVE_USER + UIUtil.toJavaScript(segmentId) + "&" + SegmentConstants.PARAMETER_EXCLUDED_USERS + "=true&" + SegmentConstants.PARAMETER_USER_IDS + "=" %>" + userId;
...
function removeAllCustomers () {
	var url = "<%= SegmentConstants.URL_SEGMENT_REMOVE_USER + UIUtil.toJavaScript(segmentId) + "&" + SegmentConstants.PARAMETER_EXCLUDED_USERS + "=true&" + SegmentConstants.PARAMETER_ALL_USERS + "=true" %>";
