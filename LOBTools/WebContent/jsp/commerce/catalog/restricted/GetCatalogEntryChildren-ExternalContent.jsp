...
<wcf:getData type="com.ibm.commerce.catalog.facade.datatypes.CatalogEntryType"
	var="catalogEntry"
	expressionBuilder="getCatalogEntryExternalContentByID"
...
<objects
	...
	<c:forEach var="externalContentReference" items="${catalogEntry.externalContentReference}">
		<object objectType="CatalogEntryExternalContentReference">
			...
			<object objectType="CatalogEntryExternalContent">
				<catId><wcf:cdata data="${param.parentId}"/></catId>
