...
<c:forEach var="ioImport" items="${ioImports}">
	<object objectType="IntelligentOfferImportSummary" readonly="true">
		<summaryId>${param.ioImportId}</summaryId>
		<summary><wcf:cdata data="${ioImport.processFile[0].processInfo}"/></summary>
	</object>
</c:forEach>
</objects>