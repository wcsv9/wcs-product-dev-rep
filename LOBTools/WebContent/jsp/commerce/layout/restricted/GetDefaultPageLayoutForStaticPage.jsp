...
<wcf:getData type="com.ibm.commerce.infrastructure.facade.datatypes.StorePageType[]"
	var="defaultPageLayout" expressionBuilder="findPageLayoutAssociationByPageType" varShowVerb="showVerb"   
...
<objects>	
	<c:forEach var="defaultPageLayoutAssociation" items="${defaultPageLayout}">        
		...
		<jsp:directive.include file="serialize/SerializeDefaultPageLayoutForStaticPage.jspf" />     
	</c:forEach>
</objects>