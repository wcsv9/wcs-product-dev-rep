...
<wcf:getData
	...
	var="contentSpots" expressionBuilder="findByUsageAndNameOrDescription"
	...
	<wcf:param name="usage" value="CONTENT" />
</wcf:getData>
<objects
...
<c:forEach var="spot" items="${contentSpots}">
	<c:set var="showVerb" value="${showVerb}" scope="request"/>
	<c:set var="businessObject" value="${spot}" scope="request"/>
	<jsp:directive.include file="SerializeMarketingContentSpot.jspf" />
</c:forEach>
</objects>
