...
<wcf:getData
	...
	var="countries" expressionBuilder="findByUniqueID">
	<wcf:param name="uniqueId" value="com.ibm.commerce.foundation.country" />
</wcf:getData>
<values>
	<c:forEach var="attribute" items="${countries.configurationAttribute}">
