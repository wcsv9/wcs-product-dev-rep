...
<c:set var="objectType" value="AcctBusinessCondition"/>
<c:set var="parent" value="${element.parentElementIdentifier.name}"/>

<c:if test="${empty element.simpleConditionVariable}">
	<c:set var="objectType" value="AcctBusinessOrList"/>
	<c:set var="parent" value="AcctBusiness"/>

	<object objectType="AcctBusiness">
		<parent>
