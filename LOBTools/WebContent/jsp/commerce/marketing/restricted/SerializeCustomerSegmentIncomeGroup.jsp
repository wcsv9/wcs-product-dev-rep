...
<c:set var="objectType" value="IncomeGroupCondition"/>
<c:set var="parent" value="${element.parentElementIdentifier.name}"/>

<c:if test="${empty element.simpleConditionVariable}">
	<c:set var="objectType" value="IncomeGroupOrList"/>
	<c:set var="parent" value="IncomeGroup"/>

	<object objectType="IncomeGroup">
		<parent>
