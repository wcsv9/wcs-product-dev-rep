...
<c:choose>
	<c:when test="${empty element.simpleConditionVariable}">
		<c:set var="objectType" value="InterestsList"/>
		<c:set var="parent" value="Interests"/>
		...
		<c:choose>
			<c:when test="${element.conditionUsage == 'andListCondition' && foundChild != null && foundChild.simpleConditionOperator == 'doesNotContain'}">
				<c:set var="template" value="notAny"/>
			</c:when>
			<c:when test="${element.conditionUsage == 'andListCondition' && foundChild != null && foundChild.simpleConditionOperator == 'contains'}">
	...
	<c:otherwise>
		<c:set var="objectType" value="InterestsContainOption"/>
		<c:if test="${element.simpleConditionOperator == 'doesNotContain'}" >
			<c:set var="objectType" value="InterestsNotContainOption"/>
		</c:if>
