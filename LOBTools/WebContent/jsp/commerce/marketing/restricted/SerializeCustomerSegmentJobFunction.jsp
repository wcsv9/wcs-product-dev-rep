...
<c:set var="objectType" value="JobFunctionCondition"/>
<c:set var="parent" value="${element.parentElementIdentifier.name}"/>

<c:if test="${empty element.simpleConditionVariable}">
	<c:set var="objectType" value="JobFunctionOrList"/>
	<c:set var="parent" value="JobFunction"/>

	<object objectType="JobFunction">
		<parent>
