...
<c:set var="objectType" value="MaritalStatusCondition"/>
<c:set var="parent" value="${element.parentElementIdentifier.name}"/>

<c:if test="${empty element.simpleConditionVariable}">
	<c:set var="objectType" value="MaritalStatusOrList"/>
	<c:set var="parent" value="MaritalStatus"/>

	<object objectType="MaritalStatus">
		<parent>
