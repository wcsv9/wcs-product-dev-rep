...
<c:choose>
	...
	<c:otherwise>
		<wcf:getData
			...
			var="priceConstants" expressionBuilder="findPriceConstantsByName" varShowVerb="showVerb"
		...
		<objects
			...
			<c:forEach var="priceConstant" items="${priceConstants}">
				<jsp:directive.include file="serialize/SerializePriceConstant.jspf" />
			</c:forEach>
		</objects>
	</c:otherwise>
</c:choose>