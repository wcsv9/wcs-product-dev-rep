...
<wcf:getData
	...
	var="priceRules" expressionBuilder="getPriceRulesReferenceForPriceConstant" varShowVerb="showVerb"
...
<objects
	...
	<c:forEach var="priceRule" items="${priceRules}">
		...
		<jsp:directive.include file="serialize/SerializePriceConstantRuleElementReferences.jspf" />
	</c:forEach>
</objects>