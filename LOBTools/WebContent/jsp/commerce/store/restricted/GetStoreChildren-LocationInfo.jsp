...
<objects>
	<c:forEach var="locationInfo" items="${onlineStores.onlineStoreLocationInfo}">
			<c:set var="info" value="${locationInfo}" scope="request"/>
			<c:set var="objectType" value="StoreLocationInformation" scope="request"/>
