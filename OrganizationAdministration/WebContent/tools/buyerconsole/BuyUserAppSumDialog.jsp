...
<%
    if(userBean.getLogonId() != null) {
       out.println("</TD><TD><i>" + UIUtil.toHTML(userBean.getLogonId()) + "</i><BR>");
    }
%>
</TD>
</TR>
...
<%
    if(orgName != null) {
       out.println("</TD><TD><i>" + UIUtil.toHTML(orgName) + "</i><BR>");
    }
%>
</TD>
</TR>
...
<%
    if(urdb.getDepartmentNumber() != null) {
       out.println("</TD><TD><i>" + UIUtil.toHTML(urdb.getDepartmentNumber()) + "</i><BR>");
    }
%>
</TD>
</TR>
...
<%
    if(urdb.getEmail1() != null) {
       out.println("</TD><TD><i>" + UIUtil.toHTML(urdb.getEmail1()) + "</i><BR>");
    }
%>
</TD>
</TR>
