...
createDynamicButtons("nbp");

if (hasFinish.toUpperCase() != "NO") {
    document.writeln('					<td align="center">');
    document.writeln('						<button id="nbOK" name="OkButton" onclick="parent.finish();">' + parent.getOkNLS() + '</button>');
    document.writeln('					</td>');
}

if (hasCancel.toUpperCase() != "NO") {
    document.writeln('					<td align="center">');
    document.writeln('						<button id="nbCancel" name="CancelButton" onclick="parent.cancel();">' + parent.getCancelNLS() + '</button>');
    document.writeln('					</td>');
}    
