...
<input type="hidden" name="authToken" value="${authToken}" id="WC_ChangeActionGroupForm_FormInput_authToken"/>
<TABLE>
  <TR>
...
<TR>
   <TD ALIGN="LEFT"><STRONG><label for="actionAvailable1"><%= UIUtil.toHTML((String)policyNLS.get("actionAvailableHeader")) %></label></STRONG></TD>
  </TR><TR>
    <TD VALIGN="BOTTOM" CLASS="selectWidth">
...
%>
    ...
    <INPUT TYPE="HIDDEN" NAME="actionGroupId" VALUE="<%= UIUtil.toHTML(actGrpId) %>">
