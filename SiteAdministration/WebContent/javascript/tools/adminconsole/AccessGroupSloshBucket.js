...
//*-------------------------------------------------------------------
   ...
   function submitCancelHandler()
   {
     ...
     {
parent.location.replace(top.getWebappPath() + "AccessGroupDynamicListView?ActionXMLFile=adminconsole.AccessGroupList&cmd=AdminAccessGroupView&selected=SELECTED&listsize=20&startindex=0&refnum=0");
     }
   }
