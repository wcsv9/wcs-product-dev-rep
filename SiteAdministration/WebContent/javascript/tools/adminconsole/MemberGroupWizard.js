   ...
   function submitErrorHandler(submitErrorMessage, submitErrorStatus)
 {
  if (submitErrorStatus == "segmentExists")
   ...
   function submitCancelHandler()
   {
	...
	parent.location.replace(top.getWebappPath() + "DynamicListSCView?ActionXMLFile=adminconsole.MemberGroupList&cmd=AdminConMemberGroupView&listsize=20&startindex=0&refnum=0");
	}
   }
