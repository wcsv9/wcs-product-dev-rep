...
function handleOK()
{
  ...
  top.mccbanner.trail[top.mccbanner.counter].location = top.getWebappPath() + 'NewDynamicListView?ActionXMLFile=approvals.approvalList&amp;cmd=AwaitingApprovalListView';
