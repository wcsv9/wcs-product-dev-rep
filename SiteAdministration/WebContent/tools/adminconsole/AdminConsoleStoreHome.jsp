		...
		<tbody>									
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					<%= adminConsoleNLS.get("admin_sec6_text") %>
					<ul class="entry_list">
						<%= adminConsoleNLS.get("admin_sec6_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					...
					<ul class="entry_list">
						<%= adminConsoleNLS.get("admin_store_sec2_list") %>
					</ul>
				</td>
			</tr>
			<%if(isPMOperational){ %>
			...
			<tr>
				<td class="entry_text" valign="top" width="449">
					...
					<ul class="entry_list">
						<%= adminConsoleNLS.get("admin_store_sec3_list") %>
					</ul>
				</td>
				<td class="entry_divider" width="1"></td>				
				<td class="entry_text" valign="top" width="449">
					...
					<ul class="entry_list">
						<%= adminConsoleNLS.get("admin_store_sec4_list") %>
					</ul>
				</td>
			</tr>
			<%}else{ %>
