...
<TITLE><%= UIUtil.toHTML((String)messagingListNLS.get("messagingMsgArchiveSearchTitle")) %></TITLE>
...
{
  return "<%= UIUtil.toJavaScript((String)messagingListNLS.get("messagingMsgArchiveTitle")) %>";
}
...
<H1><%= UIUtil.toHTML((String)messagingListNLS.get("messagingMsgArchiveSearchTitle")) %></H1>
 ...
 <INPUT TYPE="HIDDEN" NAME="tableName" VALUE="<%= tableName %>">
	...
	<TABLE>
        ...
        <TR><TD ALIGN="LEFT"><LABEL for="transportId1"><%= UIUtil.toHTML((String)messagingListNLS.get("messagingMsgViewMsgTransportColumn")) %></LABEL></TH></TR>
