...
<%!
   ...
   private void setColumnAttributes()
   {
      ...
      Vector columns = Util.convertToVector(parameterObject.get("columns"));
   ...
   private void retrieveColumnEntryString(StringBuffer result, Hashtable reportsRB, int iRowNumber, int iColumnNumber, Locale locale)
   {
	...
	//if we need the value to be passed into next page, then save it
	 // as hidden field in this page.

	if(getHiddenField() != null && getHiddenField().equalsIgnoreCase("TRUE"))
    {
      //<input type="hidden" name="theHiddenFieldRecordID" value="2">
       String name = (String) currentColumnAttributes.get("hiddenFieldName");      
        result.append("<input type=\"hidden\" name=\""+name+"\" value=\""+rowColumnEntry+"\">");
	}     
      ////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      if (currentColumnAttributes.containsKey("columnLink")){
          ...
          if (columnlink != null){
              ...
              if (parameterS !=null){
			      ...
			      {
			          aParameter = (Hashtable)e.nextElement();
			          if(aParameter != null){
   ...
   private String retrieveHeadingRowString(Hashtable reportsRB)
   {
      ...
      for (int i=0; i<columnAttributes.size(); i++) {
         ...
         String columnName = (String)reportsRB.get(getColumnName());
         if (columnName != null) {
 ...
 // defect #27068 - toHTML
   ...
   private String generateOutputTable(String reportPrefix, Hashtable reportsRB, Locale locale)
   {
      ...
      buff.append("<TABLE CELLSPACING=5 CELLPADDING=0>\n");
   ...
   private String formatColumnEntry(int rowIndex, Hashtable currentColumnAttributes, Hashtable reportsRB, String value, Locale locale)
   {
	  ...
	  } else if (getColumnType().equalsIgnoreCase("time"))  {
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
   public String getFormattedTime(String value)
   {
     return (String) TimestampHelper.getTimeFromTimestampWithSeconds(ECStringConverter.StringToTimestamp(value));
   }
   ///////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   {
      return (String) currentColumnAttributes.get("hiddenField");
   }
%>
