...
<c:if test="${!pageloaded_storelocPopupJSPF}">
	<div id="storeLocatorPopup" role="dialog" data-widget-type="wc.WCDialog" style="display:none;" onkeypress="QuickInfoJS.setFocus" aria-label="<wcst:message key="QUICK_VIEW" bundle="${widgetText}"/>">
			...
			<div class="middle">
				<div class="content_left_border">
					<div class="content_right_border">
						<%out.flush();%>
						<c:import url="/Widgets_801/Common/StoreLocatorPopup/StoreLocator.jsp">
