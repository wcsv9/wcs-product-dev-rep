...
<div id="<c:out value='${widgetName}'/>_Widget" >
	...
	<span id="WC_${widgetName}_OrganizationUserList_ToolTip" tabindex="0" class="more_info_icon verticalAlign_middle" data-widget-type="wc.tooltip" 	
		...
		<img class="info_on" src="${jsIBMWidgetsAssetsPrefix}images/icon_info_ON.png" alt="<wcst:message key="${widgetNameCaps}_TTITLE_TOOLTIP" bundle="${widgetText}"/>"/>
		<img class="info_off" src="${jsIBMWidgetsAssetsPrefix}images/icon_info.png" alt="<wcst:message key="${widgetNameCaps}_TTITLE_TOOLTIP" bundle="${widgetText}"/>"/>
	</span>
	</div>
