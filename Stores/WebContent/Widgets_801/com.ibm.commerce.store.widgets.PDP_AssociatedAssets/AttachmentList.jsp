				...
				<c:forEach var="attachmentDetails" items="${attachmentsList.value}" varStatus="status">
					<div class="attachment">
						...
						<c:choose>
							...
							<c:otherwise>
								<div class="icon">
									<a href="${attachmentDetails['assetPath']}" target="_new" id="WC_TechnicalSpecification_Image_2_${status.count}">
										<img src="${attachmentDetails['image']}" alt="${attachmentNameToDisplay}" title="${attachmentNameToDisplay}"/>
									</a>
								</div>
								<div class="description">
									<a href="${attachmentDetails['assetPath']}" target="_new" id="WC_TechnicalSpecification_Links_2_${status.count}"> 
