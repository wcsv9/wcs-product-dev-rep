...
@ApiModel(description = "This is the pre UE response for the user registration controller commands")
public class PersonPreUEResponse extends PreUEResponse implements
		PersonUEResponse {
