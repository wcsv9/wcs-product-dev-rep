...
@ApiModel(description = "This is the replace UE response for the order controller commands")
public class OrderReplaceUEResponse extends ReplaceUEResponse implements
		OrderUEResponse {
