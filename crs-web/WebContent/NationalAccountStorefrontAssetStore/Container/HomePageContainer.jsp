...
<style>
div#page.homePage .home-page-Container {
    padding-top: 0;
}
...
<div class="rowContainer home-page-Container" id="container_${pageDesign.layoutId}">
    ...
    <button class="tablink tab-1" onclick="openPage('HomeTab-1', this, '#eb2227')" id="defaultOpen">SPECIAL OFFERS</button>
	<button class="tablink tab-2" onclick="openPage('HomeTab-2', this, '#eb2227')" >INITIATIVE RANGE</button>
	<button class="tablink tab-3" onclick="openPage('HomeTab-3', this, '#eb2227')">LATEST PRODUCTS</button>
	<button class="tablink tab-4" onclick="openPage('HomeTab-4', this, '#eb2227')">HOTTEST PICKS</button>
	...
	<div id="HomeTab-4" class="col12 acol12 tabcontent" data-slot-id="10"><wcpgl:widgetImport slotId="10"/></div>
