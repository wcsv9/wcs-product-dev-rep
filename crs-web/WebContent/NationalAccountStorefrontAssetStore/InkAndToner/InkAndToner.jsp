...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
	    ...
	    <link rel="canonical" href="<c:out value="${env_InkAndTonerURL}"/>" />
		...
		<flow:ifEnabled feature="FacebookIntegration">
			...
			<meta property="og:url" content="<c:out value="${env_InkAndTonerURL}"/>"/>
  ...
  <%@ include file="ProductQuickFind.jspf"%>
