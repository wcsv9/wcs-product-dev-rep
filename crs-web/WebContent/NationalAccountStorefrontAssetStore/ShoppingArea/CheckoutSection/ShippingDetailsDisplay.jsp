...
<%-- <div class="main_header" id="WC_ShipmentDisplay_div_5">
	...
	ali commit <div class="headingtext" id="WC_ShipmentDisplay_div_7"><span aria-level="1" class="main_header_text" role="heading"><fmt:message bundle="${storeText}" key="BCT_SHIPPING_INFO"/></span></div>
...
<a id="OrderItemDetails_plusImage_link"
	href="javaScript:CheckoutHelperJS.toggleOrderItemDetailsShipping('WC_ShipmentDisplay_div_17', 'traditionalShipmentDetailsContext', 'true'); "
	onclick="javaScript:TealeafWCJS.processDOMEvent(event); ShowHideItem('headPlus4','showHideOrders');">
	<img id="OrderItemDetailsPlus" style="display: inline"
	src="<c:out value='${jspStoreImgDir}images/'/>icon_plus.png">
	<div class="ordShipBillHeaders">
		<div class="ordShipHeaderSign headPlus4">+</div>
		<div class="left_corner_straight"></div>
		<div class="ordShipBillHeaderTxt">
			<span aria-level="1" class="main_header_text" role="heading">
				<p id="OrderItemDetailsShowPrompt" style="display: inline">
					<fmt:message bundle="${storeText}" key="SHOW_ORDER_ITEMS" />
				</p>
			</span>
		</div>
...
<a id="OrderItemDetails_minusImage_link" style="display: none"
	href="javaScript:CheckoutHelperJS.toggleOrderItemDetailsShipping('WC_ShipmentDisplay_div_17', 'traditionalShipmentDetailsContext', 'true');"
	onclick="javaScript:TealeafWCJS.processDOMEvent(event); ShowHideItem('headPlus4','showHideOrders');">
	<img id="OrderItemDetailsMinus" style="display: none"
	src="<c:out value='${jspStoreImgDir}images/'/>icon_minus.png">
	<div class="ordShipBillHeaders">
		<div class="ordShipHeaderSign headPlus4">+</div>
		<div class="left_corner_straight"></div>
		<div class="ordShipBillHeaderTxt">
			<span aria-level="1" class="main_header_text" role="heading"><p
					id="OrderItemDetailsHidePrompt" style="display: none;">
					<fmt:message bundle="${storeText}" key="HIDE_ORDER_ITEMS" />
				</p> </span>
		</div>

	</div>
</a>
<div class="left showHideOrders col12" id="WC_ShipmentDisplay_div_16" style="display: none;">
	<div id="shipping">
		<c:choose>
			<c:when test = "${shipmentTypeId == 1}">
			<%-- ali commit
