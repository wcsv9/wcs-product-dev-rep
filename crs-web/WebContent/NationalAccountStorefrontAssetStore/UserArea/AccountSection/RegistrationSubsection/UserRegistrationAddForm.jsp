...
//             MessageHelper.setMessage("ERROR_MOBILE_PHONE_EMPTY", Utils.getLocalizationMessage('ERROR_MOBILE_PHONE_EMPTY'));
            ...
            MessageHelper.setMessage("ERROR_ABNEmpty", Utils.getLocalizationMessage('ERROR_ABNEmpty'));
            MessageHelper.setMessage("ERROR_AbnNo", Utils.getLocalizationMessage('ERROR_AbnNo'));
            MessageHelper.setMessage("ERROR_ContractEmpty", Utils.getLocalizationMessage('ERROR_ContractEmpty'));
        });
