...
CommonControllersDeclarationJS = {
	...
	/**
       ...
       setRefreshURL:function(refreshAreaId,url){
         ...
         * Refresh controller for fetching discount details for quick info.
         */
        declarecontractUserAdminController: function() {
            var widgetObj = $("#contractUserAdminArea");
            wcRenderContext.addRefreshAreaId("contractUserAdminContext", "contractUserAdminArea");
            var renderContextProperties = wcRenderContext.getRenderContextProperties("contractUserAdminContext");
