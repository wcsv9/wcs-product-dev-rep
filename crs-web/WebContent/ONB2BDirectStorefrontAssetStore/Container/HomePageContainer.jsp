...
<div class="rowContainer home-page-Container" id="container_${pageDesign.layoutId}">
    ...
    <button class="tablink tab-1" onclick="openPage('HomeTab-1', this, '#1a428a')" id="defaultOpen">SPECIAL OFFERS</button>
	<button class="tablink tab-2" onclick="openPage('HomeTab-2', this, '#1a428a')" >INITIATIVE RANGE</button>
	<button class="tablink tab-3" onclick="openPage('HomeTab-3', this, '#1a428a')">LATEST PRODUCTS</button>
	<button class="tablink tab-4" onclick="openPage('HomeTab-4', this, '#1a428a')">HOTTEST PICKS</button>
