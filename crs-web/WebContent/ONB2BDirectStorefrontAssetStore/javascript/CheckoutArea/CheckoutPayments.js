	...
	*/
	...
	showSummaryPage:function(){
		...
		if(selectBoxValueArray[0] != "PayPal"){
			...
			document.location.href="PunchoutPaymentRedirectView?langId="+this.langId+"&storeId="+this.storeId+"&catalogId="+this.catalogId+"&orderId="+document.getElementById("orderId1").value;
		}
	},
