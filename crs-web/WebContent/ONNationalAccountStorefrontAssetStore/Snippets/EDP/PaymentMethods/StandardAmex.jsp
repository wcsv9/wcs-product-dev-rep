	...
	<span class="col1">
		...
		<span class="visaCVV2">
			<span id="CVVDetailsSection_<c:out value='${paymentAreaNumber}'/>">		
					<span id="StandardAmex_CVVDetails_<c:out value='${paymentAreaNumber}'/>" class="order_link"  data-widget-type="wc.tooltip" 
					data-tooltip-header="<fmt:message key='EDPPaymentMethods_CVV_WHAT_IS' bundle='${storeText}'/>"
					data-tooltip-content="<fmt:message key='EDPPaymentMethods_CVV_DEFINITION' bundle='${storeText}'/>"  tabindex="0">
