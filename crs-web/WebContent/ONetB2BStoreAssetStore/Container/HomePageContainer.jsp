...
<div class="rowContainer home-page-Container" id="container_${pageDesign.layoutId}">
    ...
    <button class="tablink tab-1" onclick="openPage('HomeTab-1', this, '#ff4f54')" id="defaultOpen">LATEST PRODUCTS </button>
	<button class="tablink tab-2" onclick="openPage('HomeTab-2', this, '#ff4f54')" >BEST SELLERS </button>
	<button class="tablink tab-3" onclick="openPage('HomeTab-3', this, '#ff4f54')">SALE PRODUCTS </button>
	<button class="tablink tab-4" onclick="openPage('HomeTab-4', this, '#ff4f54')">HOTTEST PICKS </button>
