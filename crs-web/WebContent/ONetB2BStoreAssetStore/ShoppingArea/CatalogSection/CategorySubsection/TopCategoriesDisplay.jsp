...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	...
	$(window).scroll(function(){
		var yourTop = $('#headerRow2').position().top;
		if( $(this).scrollTop() > yourTop ){
			$(".navHead").addClass("stickyHead");
			$(".topRowCart").addClass("stickyHead");
		}
		else if( $(this).scrollTop() < yourTop ){
			$(".navHead").removeClass("stickyHead");
			$(".topRowCart").removeClass("stickyHead");
		}
	});
	</script>
	<body>
