...
<div class="shipping_method" id="WC_SingleShipmentShippingMethodDetails_div_1">
	<p class="title shipAddTitle">
		<label for="singleShipmentShippingMode">Shipping Method</label>
	</p>
	...
	<div name = "shippingInstructionsDiv" id = "shippingInstructionsDiv" style="display:<c:out value='${shippingInstructionsDivDisplay}'/>">
          ...
          <span><b>Shipping Instructions</b></span><span class="spanacce"><fmt:message bundle="${storeText}" key="SHIP_SHIPPING_INSTRUCTIONS_LABEL" /></span>
      </label>
				
					
					<textarea id="shipInstructions" class="shipMethodTxtArea" name="shipInstructions" rows="2" cols="35" ><c:out value = "${shipInstructions}" /></textarea>
