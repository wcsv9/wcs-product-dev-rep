...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${shortLocale}" xml:lang="${shortLocale}">
	...
	<!-- Paypal Start -->
		<input type="hidden" name="POId" id="POId" value="${WCParam.poid}"/>
		<input type="hidden" name="costCentre_id" id="costCentre_id" value="${WCParam.cCentreId}" />
	<!-- Paypal End -->
		<%-- Page Start --%>
	...
	<!-- Paypal Start -->
		<script type="text/javascript">
		$(document).ready(function() { 
			//CheckoutHelperJS.setCostCentre('<c:out value='${WCParam.cCentreId}'/>');
			CheckoutHelperJS.checkoutOrder(${WCParam.orderId},'<c:out value='${userType}'/>','<c:out value='${addressListForMailNotification}'/>');
		});
		</script>		
	<!-- Paypal End -->
