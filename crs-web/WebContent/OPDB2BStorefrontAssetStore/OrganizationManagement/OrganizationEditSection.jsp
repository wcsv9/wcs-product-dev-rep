				...
				<div class="col12">
					...
					<div class="row col12">
						...
						<div class="col7"><input class="inputField" type="text"   maxlength="30" size="35" id="new_cost_centre" name="new_cost_centre">
				 		<input type="hidden" name="userField1" value="rer;welcom" id="costCentreCombined" autocomplete="off"></div>
					...
					<span class="col10" name="costCentreBox" id="costCentreBox" style="display: block; margin-top: 5px;">
					 		...
					 		<option value="rer">rer</option><option value="welcom">welcome</option></select>
					 		<br> &nbsp;
					</span>
					<br clear="all"> 
