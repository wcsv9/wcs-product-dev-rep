...
<div class="shipping_address" id="WC_ShippingAddressSelectSingle_div_1">
	<p class="title shipAddTitle"><label for="singleShipmentAddress"><fmt:message bundle="${storeText}" key="SHIP_SHIPPING_ADDRESS_COLON"/></label></p>
	...
	<div class="refAreaInside" wcType="RefreshArea" id="shippingAddressDisplayArea" widgetId="shippingAddressDisplayArea" declareFunction="declareShippingAddressDisplayAreaController()" refreshurl="${AddressDisplayURL}"
