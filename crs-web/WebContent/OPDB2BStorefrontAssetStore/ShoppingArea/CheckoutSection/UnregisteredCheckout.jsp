			...
			<div class="content_right_shadow">
				<div class="main_content">
					<div class="container_full_width">
						...
						<!-- Breadcrumb End -->
						<div id="box" class="unRegisteredPage">
							...
							<div class="body" id="WC_UnregisteredCheckout_div_9">
								...
								<c:if test="${WCParam.storeId eq '81852'}">
											<div id="orderItem-total">
													<%out.flush();%>
													<c:import url="/${sdb.jspStoreDir}/Snippets/Order/Cart/OrderItemDetailB2C.jsp">
													...
													<%out.flush();%>
														<c:import url="/${sdb.jspStoreDir}/ShoppingArea/CheckoutSection/SingleShipment/SingleShipmentOrderTotalsSummaryB2C.jsp">
										...
										<script>
										  ga('ec:setAction','checkout', {
											...
											'option': "${fn:escapeXml(sessionScope.storeName1)}"     // Optional additional info
										  });
