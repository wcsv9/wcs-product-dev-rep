...
<div class="card_info" id="WC_StandardMasterCard_div_1_<c:out value='${paymentAreaNumber}'/>">
	...
	<input type="hidden" id="mandatoryFields_<c:out value='${paymentAreaNumber}'/>" name="mandatoryFields"  value="account_<c:out value='${paymentAreaNumber}'/>,expire_month_<c:out value='${paymentAreaNumber}'/>,expire_year_<c:out value='${paymentAreaNumber}'/>,cc_nameoncard_<c:out value='${paymentAreaNumber}'/>,cc_cvc_<c:out value='${paymentAreaNumber}'/>,billing_address_id"/>
	...
	<span class="col1">
		...
		<div class="col7 row setWidthIpadCardNum">
			...
			<div>
				<input aria-required="true" type="tel" onchange="JavaScript:TealeafWCJS.processDOMEvent(event);CheckoutPayments.removeCreditCardNumberAndCVV(<c:out value='${paymentAreaNumber}'/>, false, true);CheckoutHelperJS.paymentDataDirty(<c:out value='${paymentAreaNumber}'/>, true);CheckoutPayments.updatePaymentObject(<c:out value='${paymentAreaNumber}'/>, 'account');" name="account1" value="<c:out value="${accountValue}"/>" id="account1_<c:out value='${paymentAreaNumber}'/>"/>
			</div>
		</div>
		...
		<input style="width: 80%" type="tel" onchange="JavaScript:TealeafWCJS.processDOMEvent(event);CheckoutPayments.removeCreditCardNumberAndCVV(<c:out value='${paymentAreaNumber}'/>, true, false);CheckoutHelperJS.paymentDataDirty(<c:out value='${paymentAreaNumber}'/>, true);CheckoutPayments.updatePaymentObject(<c:out value='${paymentAreaNumber}'/>, 'cc_cvc');" name="cc_cvc" size="4" value="<c:out value='${cc_cvc}' />" id="cc_cvc_<c:out value='${paymentAreaNumber}'/>"/>
		<span class="visaCVV2">
			<span id="CVVDetailsSection_<c:out value='${paymentAreaNumber}'/>">	
				...
				<script type="text/javascript">$( document ).ready(function() {parseWidget("StandardMasterCard_CVVDetails_<c:out value='${paymentAreaNumber}'/>_span_2"); });</script>
			</span>
		</span>
		</div>
		</div>
