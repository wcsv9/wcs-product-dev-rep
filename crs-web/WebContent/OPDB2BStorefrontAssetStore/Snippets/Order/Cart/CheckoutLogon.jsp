	...
	<c:if test="${currentOrderLocked != 'true' || env_shopOnBehalfSessionEstablished eq 'true'}">
		<div class="left" id="shopcartCheckoutButton">
			<span class="button_bottom">
				<%-- <a href="#" class="button_secondary" style="width:53%;text-align:center;padding: 10px 0px;font-size: 10px;" title="Remove My Order" onclick="javascript:if(CheckoutHelperJS.confirmRemove()){location.href = '${OrderCancelURL}'}; " >
					Remove Order
				</a> --%>
				<a href="#" class="button_secondary" style="width:53%;text-align:center;padding: 10px 0px;font-size: 10px;" title="Remove My Order" onclick="javascript:if(OrderListJS.confirmRemove()){OrderListJS.customRemoveOrder(${WCParam.storeId}, ${order.orderId });}; " >
					Remove Order
				</a>
			</span>
			<span class="button_bottom">
				<!--<a href="#" onclick="location.href = '${OrderCopyURL}';" >-->
				<a class="button_secondary" style="width:43%;float:right;text-align:center;padding: 10px 0px;font-size: 10px;" href="#" onclick="location.href = '${SavedOrderListDisplayURL}';" >
					SAVED ORDERS
				</a>
			</span>
