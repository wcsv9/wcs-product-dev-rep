...
<select name="selectState" id="selectState" title="<fmt:message bundle="${storeText}" key='ACCE_PROVINCE_CHANGE'/>" class="drop_down_country" onchange="JavaScript:TealeafWCJS.processDOMEvent(event);storeLocatorJSStore.changeProvinceSelection(this.options[this.selectedIndex].value);">
