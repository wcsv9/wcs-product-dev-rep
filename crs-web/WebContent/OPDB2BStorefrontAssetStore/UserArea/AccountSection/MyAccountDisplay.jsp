				...
				<div class="row col12">
					<a href="${userRegistrationFormURL}">
						...
						<div class="row col12">
							...
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/userIcon.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<div class="col4 acol6 row myAccBox">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/favourites.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<div class="col4 acol6 row myAccBox">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/orderHistory.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<div class="col4 acol6 row myAccBox">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/addressBook.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<div class="col4 acol6 row myAccBox">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/shopping.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<c:if test="${sessionScope.loyaltyEnabled ne 'false' && !empty sessionScope.loyaltyEnabled }">
						...
						<div class="col4 acol6 row myAccBox">
							...
							<div class="row col12">
								<div class="col1">&nbsp;</div>
								<div class="col10 userIconLine">
									<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/rewards.png" /></div>
									<hr>
								</div>
								<div class="col1">&nbsp;</div>
							</div>
					...
					<div class="col4 acol6 row myAccBox">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/companyDetails.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<div class="col4 acol6 row myAccBox">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/recurring.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
					...
					<div class="col4 acol6 row myAccBox lastItemFullWidth">
						...
						<div class="row col12">
							<div class="col1">&nbsp;</div>
							<div class="col10 userIconLine">
								<div class="userIcon"><img src="/wcsstore/OPDB2BStorefrontAssetStore/images/approvals.png" /></div>
								<hr>
							</div>
							<div class="col1">&nbsp;</div>
						</div>
