...
<%@ include file="../../../Common/JSTLEnvironmentSetup.jspf"%>
	...
	<wcf:rest var="approvalProcess" url="store/12410/registrationApproval/ONUserRegistrationApprovalProcess/${WCParam.catalogId}/${WCParam.langId}/${regUserId_value}/${orgEntityId_value}/${approvalStatusId_value}/${aprv_act_value}/${apruserId}" scope="request">
