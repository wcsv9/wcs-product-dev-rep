...
<%@ include file="../../../Common/JSTLEnvironmentSetup.jspf"%>
	...
	<wcf:rest var="ONOrderReceivedApprovalSubmittedDisplay" url="store/12410/orderApproval/ONOrderReceivedApprovalSubmittedDisplay/${WCParam.catalogId}/${WCParam.langId}/${WCParam.orderId}/${WCParam.appMailAddress}" scope="request">
...
<body onload="OrderReceivedApprovalSubmittedDisplayInit()" style="background-image: none;">
	...
	<form name="forceLogoff" action="Logoff" method="post">
		...
		<input type="hidden" name="storeId" value="12410"/>
