...
<div class="rowContainer home-page-Container" id="container_${pageDesign.layoutId}">
    ...
    <button class="tablink tab-1" onclick="openPage('HomeTab-1', this, '#5c6f7c')" id="defaultOpen">LATEST PRODUCTS</button>
	<button class="tablink tab-2" onclick="openPage('HomeTab-2', this, '#5c6f7c')" >BEST SELLERS</button>
	<button class="tablink tab-3" onclick="openPage('HomeTab-3', this, '#5c6f7c')">SALE PRODUCTS</button>
