...
<html>
	<head>
		...
		<link rel="stylesheet" href="/wcsstore/OPDNZB2BStorefrontAssetStore/css/PrintPDP.css" type="text/css"/>
		<link rel="stylesheet" href="/wcsstore/OPDNZB2BStorefrontAssetStore/css/common1_1.css" type="text/css"/>
		<link rel="stylesheet" href="/wcsstore/OPDNZB2BStorefrontAssetStore/css/base.css" type="text/css"/>
	...
	.print{padding:3px; border: solid 2px #000; margin: auto;  text-align: left; font-family: Gotham, "Helvetica Neue", Helvetica, Arial, "sans-serif"}
...
.print-footer th {
	...
	<body onload="window.print();">
		...
		<table class="print"  cellpadding="0" cellspacing="0"  style="text-align: left; border:solid 1px #000;" bo width="750" height="599" border="0" >
			<tbody>
				<tr>
					<td scope="row">
