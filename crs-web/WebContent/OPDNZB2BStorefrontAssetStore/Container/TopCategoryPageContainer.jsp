...
<div class="rowContainer topCategory" id="container_${pageDesign.layoutId}">
	...
	<div class="row margin-true">
		 <div class="col12 acol12 ccol12 right" data-slot-id="4"><wcpgl:widgetImport slotId="4"/></div> 
		<%-- <div class="col4 acol12 ccol3" data-slot-id="5"><wcpgl:widgetImport slotId="5"/></div> --%><!-- Menu here -->
		...
		<div class="col12 acol12 ccol12 right" data-slot-id="8"><wcpgl:widgetImport slotId="8"/></div> 
	</div>
</div>
