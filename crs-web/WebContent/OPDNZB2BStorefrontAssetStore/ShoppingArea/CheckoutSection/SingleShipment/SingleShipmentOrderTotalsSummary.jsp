...
<!-- Start Frieght charges and other charges -->
<c:set var="footerLinkPages" value="TermCondPage,FastDeliveryPage"/>
...
<!-- End Frieght charges and other charges -->
...
<div id="total_breakdown" class="v9_total_breakdown">
	...
	<table id="order_total" cellpadding="0" cellspacing="0" border="0" role="presentation" class="v9_order_total">
		...
		<c:if test="${fromPage == 'shoppingCartDisplay'}">
			<tr> 
				<td class="total_details" id="WC_SingleShipmentOrderTotalsSummary_td_23"><fmt:message bundle="${storeText}" key="MO_ORDER_FREIGHTCHARGES" /><a href="${fn:replace(FastDeliveryPageViewURL,'http://','https://')}"> charges may apply</a></td>
				<%-- <td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_2"><fmt:formatNumber value="${order.totalProductPrice}" type="currency" maxFractionDigits="${env_currencyDecimal}" minFractionDigits="${env_currencyDecimal}" currencySymbol="${env_CurrencySymbolToFormat}"/><c:out value="${CurrencySymbol}"/></td>--%>
		...
		<c:if test="${param.fromPage != 'shoppingCartDisplay' && param.fromPage != 'pendingOrderDisplay'}">
			<%-- As recommended by Ali --%>
			<tr>
				<td class="total_details" id="WC_SingleShipmentOrderTotalsSummary_td_7"><fmt:message bundle="${storeText}" key="MO_ORDER_FREIGHTCHARGES" /></td>
	...
	<c:if test="${showTotals eq true}">
		...
		<%--Commenting code as requested by ALi 
		<tr> 
			<td class="total_details" id="WC_SingleShipmentOrderTotalsSummary_td_23"><fmt:message bundle="${storeText}" key="MO_ORDER_OTHERCHARGES" /><a href="${fn:replace(TermCondPageViewURL,'http://','https://')}"> charges may apply</a></td>
			<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_2"><fmt:formatNumber value="${order.totalProductPrice}" type="currency" maxFractionDigits="${env_currencyDecimal}" minFractionDigits="${env_currencyDecimal}" currencySymbol="${env_CurrencySymbolToFormat}"/><c:out value="${CurrencySymbol}"/></td>
			<td class="total_figures" id="WC_SingleShipmentOrderTotalsSummary_td_24">$0.00</td>
		</tr> --%>
