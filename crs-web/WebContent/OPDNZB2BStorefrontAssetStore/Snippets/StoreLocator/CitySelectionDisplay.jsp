...
<select name="selectCity" id="selectCity" class="drop_down_country" onchange="javaScript:TealeafWCJS.processDOMEvent(event);storeLocatorJSStore.changeCitySelection(this.options[this.selectedIndex].value);">
