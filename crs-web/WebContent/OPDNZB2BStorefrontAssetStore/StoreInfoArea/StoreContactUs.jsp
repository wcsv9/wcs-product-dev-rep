...
xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		...
		<link rel="stylesheet" href="/wcsstore/OPDNZB2BStorefrontAssetStore/css/store.css" type="text/css" />
	...
	<style>
	@media only screen and (max-width: 768px){div#content.sitemap .map {    height: 330px !important;} div#content.sitemap table h1 { font-size: 14px;    padding: 0px 0px;} div#content.sitemap table { width: 100%;    padding: 10px;    font-size: 12px;}}
	div#content.sitemap .googlemap{width: 100%;overflow: hidden; }
	div#content.sitemap .map{display:block; width: 100%;overflow: hidden; height: 600px;     padding-top: 10px;}
	...
	<body onload="addOnLoad()">
		...
		<div id="page">
			...
			<wcf:rest var="storeInfoOpdnz" url="store/{storeId}/storeDetails/storeContact/OPDNZ">
				<wcf:var name="storeId" value="${storeId}" encode="true"/>
			</wcf:rest>
			
			<c:set var="addi" value="${fn:replace(storeInfoOpdnz.stAddress1, ' ', '+')}"/>
			<c:set var="googleMapURL" value='<c:out value="${addi}"/>+<c:out value="${storeInfoOpdnz.stCity}"/>+<c:out value="${storeInfoOpdnz.stZipCode}"/>+New+Zealand'/>
					...
					<table width="100%">
						<tbody>
							<tr style="height: 25px;">
								<td style="height: 25px;" width="23%"><p>&nbsp;</p></td>
								<td style="height: 25px;" width="76%"><p>&nbsp;</p></td>
							</tr>
							<tr style="height: 25px;">
							<td style="height: 25px;" width="23%">
								<h1><span style="color: #ff6600;">Contact Us</span></h1>
							</td>
								<td style="height: 25px;" width="76%">
									<h1><span style="color: #ff6600;"><c:out value="${storeInfoOpdnz.stDisplayName}"/></span></h1>
								</td>
							</tr>
							<tr style="height: 25px;">
								<td style="height: 25px;" width="23%"><p>&nbsp;</p></td>
							...
							<tr style="height: 25px;">
								...
								<td style="height: 25px;" width="76%">
									<p><c:out value="${storeInfoOpdnz.stAddress1}"/></p>
									<p><c:out value="${storeInfoOpdnz.stCity}"/></p>
									<p><c:out value="${storeInfoOpdnz.stState}"/>&nbsp;<c:out value="${storeInfoOpdnz.stZipCode}"/></p>
									<p>New Zealand</p>
								</td>
							</tr>
							<tr style="height: 25px;">
								...
								<td style="height: 25px;" width="76%">
									<p><strong><c:out value="${storeInfoOpdnz.stPhone}"/></strong></p>
								</td>
							</tr>
							<tr style="height: 25px;">
								<td style="height: 25px;" width="23%">
								...
								<td style="height: 25px;" width="76%">
									<p><c:out value="${storeInfoOpdnz.stFax}"/></p>
								</td>
							</tr>
							<tr style="height: 25px;">
								<td style="height: 25px;" width="23%">
								...
								<td style="height: 25px;" width="76%">
									<p><a href="mailto:${storeInfoOpdnz.stEmail}"><c:out value="${storeInfoOpdnz.stEmail}"/></a></p>
								</td>
							</tr>
							<tr style="height: 25px;">
								<td style="height: 25px;" width="23%">
								...
								<td style="height: 25px;" width="76%">
									<p><a href="${storeInfoOpdnz.stStoreWebSite}"><c:out value="${storeInfoOpdnz.stStoreWebSite}"/></a></p>
								</td>
							</tr>					
						</tbody>
					</table>
					
					<c:if test="${storeInfoOpdnz.stLatitude ne 'null' && storeInfoOpdnz.stLongitude ne 'null'}">
						<div class="googlemap">
						<iframe class="map" style="display:block;"  
						src="https://maps.google.com/maps?ll=${storeInfoOpdnz.stLatitude},${storeInfoOpdnz.stLongitude}&z=15&output=embed&q=${googleMapURL}" 
