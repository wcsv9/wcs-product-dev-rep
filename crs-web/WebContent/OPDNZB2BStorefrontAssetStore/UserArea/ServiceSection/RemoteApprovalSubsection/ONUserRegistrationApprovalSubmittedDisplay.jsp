...
<%@ include file="../../../Common/JSTLEnvironmentSetup.jspf"%>
	...
	<wcf:rest var="approvalDisplay" url="store/12410/registrationApproval/ONUserRegistrationApprovalSubmittedDisplay/${WCParam.catalogId}/${WCParam.langId}/${WCParam.userId}/${WCParam.orgEntityId}/${WCParam.apruserId}">
