...
<c:set var="forwardParameter" value="${WCParam.forwardParameter}" scope="page" />
	...
	<wcf:rest var="orderApprovalProcess" url="store/12410/orderApproval/ONOrderApprovalProcess/${WCParam.catalogId}/${WCParam.langId}/${WCParam.orderId}/${approvalStatusId}/${aprv_act_value}/${modifyOrder_value}/${editOrder_value}/${ordButtonRej_value}/${ordButtonApp_value}" scope="request">
				...
				<tr> 
				 <td>
					 ...
					 <flow:ifEnabled feature="ShippingInstructions">
				     	...
				     	<wcf:rest var="orderIdd" url="store/12410/order/{orderId}" scope="request">
							<wcf:var name="storeId" value = "${WCParam.storeId}" encode="true"/>
							<wcf:var name="catalogId" value="${WCParam.catalogId}"/>
				      		<wcf:var name="langId" value="${WCParam.langId}"/>
...
OrderReceivedApprovalSubmittedDisplayURL :: ${OrderReceivedApprovalSubmittedDisplayURL }
	...
	<c:set var="ZZOrderId" value="${WCParam.orderId}"/>	
		...
		<wcf:rest var="ZZpagorder" url="store/12410/order/{orderId}" scope="request">
			<wcf:var name="storeId" value = "${WCParam.storeId}" encode="true"/>
			<wcf:var name="catalogId" value="${WCParam.catalogId}"/>
			<wcf:var name="langId" value="${WCParam.langId}"/>
			<wcf:var name="orderId" value="${ZZOrderId}"/>	     		
