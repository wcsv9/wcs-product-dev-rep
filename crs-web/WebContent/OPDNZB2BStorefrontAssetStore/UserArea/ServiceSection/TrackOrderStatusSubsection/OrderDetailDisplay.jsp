						...
						<div class="row margin-true">
							...
							<flow:ifEnabled feature="SideBySideIntegration">
								...
								<div id="orderDetail_content">
											...
											<div class="row pageSection leftAlignBtn"/>
												<a class="button_primary" onclick="PrintMe();" class="button_primary" href="#" id="WC_OrderDetailDisplay_Print_Link" role="button">
							...
							<flow:ifDisabled feature="SideBySideIntegration">							
								...
								<c:if test="${WCParam.currentSelection eq 'SchedullerOrderDetailSlct'}" >
									<div class="content scheduleOrderDisplayExt">
										<%out.flush();%>
										<c:import url="/${sdb.jspStoreDir}/ShoppingArea/CheckoutSection/ScheduleOrderDisplayExt.jsp">
											...
											<c:param value="true" name="isMyAccountPage"/>
											<c:param value="${WCParam.orderId}" name="orderId"/>
										</c:import>
										<%out.flush();%>
									</div>
								</c:if>
